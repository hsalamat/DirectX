...
//Step 1: Initialization involves first setting up the global variables and classes, and an initialize function must prepare the pipeline and assets.
...
#if defined(_DEBUG)
    // Step2: Enable the debug layer (requires the Graphics Tools "optional feature").
