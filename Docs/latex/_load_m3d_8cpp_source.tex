...
\DoxyCodeLine{\Hypertarget{_load_m3d_8cpp_source_l00030}00030         ReadMaterials(fin, numMaterials, mats);}
\DoxyCodeLine{\Hypertarget{_load_m3d_8cpp_source_l00031}00031         ReadSubsetTable(fin, numMaterials, subsets);}
\DoxyCodeLine{\Hypertarget{_load_m3d_8cpp_source_l00032}00032         ReadVertices(fin, numVertices, vertices);}
\DoxyCodeLine{\Hypertarget{_load_m3d_8cpp_source_l00033}00033         ReadTriangles(fin, numTriangles, indices);}
...
\DoxyCodeLine{\Hypertarget{_load_m3d_8cpp_source_l00070}00070         ReadMaterials(fin, numMaterials, mats);}
\DoxyCodeLine{\Hypertarget{_load_m3d_8cpp_source_l00071}00071         ReadSubsetTable(fin, numMaterials, subsets);}
\DoxyCodeLine{\Hypertarget{_load_m3d_8cpp_source_l00072}00072         ReadSkinnedVertices(fin, numVertices, vertices);}
\DoxyCodeLine{\Hypertarget{_load_m3d_8cpp_source_l00073}00073         ReadTriangles(fin, numTriangles, indices);}
\DoxyCodeLine{\Hypertarget{_load_m3d_8cpp_source_l00074}00074         ReadBoneOffsets(fin, numBones, boneOffsets);}
\DoxyCodeLine{\Hypertarget{_load_m3d_8cpp_source_l00075}00075         ReadBoneHierarchy(fin, numBones, boneIndexToParentIndex);}
\DoxyCodeLine{\Hypertarget{_load_m3d_8cpp_source_l00076}00076         ReadAnimationClips(fin, numBones, numAnimationClips, animations);}
...
\DoxyCodeLine{\Hypertarget{_load_m3d_8cpp_source_l00085}00085 \textcolor{keywordtype}{void} M3DLoader::ReadMaterials(std::ifstream\& fin, UINT numMaterials, std::vector<M3dMaterial>\& mats)}
...
\DoxyCodeLine{\Hypertarget{_load_m3d_8cpp_source_l00107}00107 \textcolor{keywordtype}{void} M3DLoader::ReadSubsetTable(std::ifstream\& fin, UINT numSubsets, std::vector<Subset>\& subsets)}
...
\DoxyCodeLine{\Hypertarget{_load_m3d_8cpp_source_l00123}00123 \textcolor{keywordtype}{void} M3DLoader::ReadVertices(std::ifstream\& fin, UINT numVertices, std::vector<Vertex>\& vertices)}
...
\DoxyCodeLine{\Hypertarget{_load_m3d_8cpp_source_l00138}00138 \textcolor{keywordtype}{void} M3DLoader::ReadSkinnedVertices(std::ifstream\& fin, UINT numVertices, std::vector<SkinnedVertex>\& vertices)}
...
\DoxyCodeLine{\Hypertarget{_load_m3d_8cpp_source_l00167}00167 \textcolor{keywordtype}{void} M3DLoader::ReadTriangles(std::ifstream\& fin, UINT numTriangles, std::vector<USHORT>\& indices)}
...
\DoxyCodeLine{\Hypertarget{_load_m3d_8cpp_source_l00179}00179 \textcolor{keywordtype}{void} M3DLoader::ReadBoneOffsets(std::ifstream\& fin, UINT numBones, std::vector<XMFLOAT4X4>\& boneOffsets)}
...
\DoxyCodeLine{\Hypertarget{_load_m3d_8cpp_source_l00195}00195 \textcolor{keywordtype}{void} M3DLoader::ReadBoneHierarchy(std::ifstream\& fin, UINT numBones, std::vector<int>\& boneIndexToParentIndex)}
...
\DoxyCodeLine{\Hypertarget{_load_m3d_8cpp_source_l00207}00207 \textcolor{keywordtype}{void} M3DLoader::ReadAnimationClips(std::ifstream\& fin, UINT numBones, UINT numAnimationClips, }
...
\DoxyCodeLine{\Hypertarget{_load_m3d_8cpp_source_l00223}00223             ReadBoneKeyframes(fin, numBones, clip.\mbox{\hyperlink{struct_animation_clip_acd53e690312cafca9a0bc7e2d9f47a42}{BoneAnimations}}[boneIndex]);}
...
\DoxyCodeLine{\Hypertarget{_load_m3d_8cpp_source_l00231}00231 \textcolor{keywordtype}{void} M3DLoader::ReadBoneKeyframes(std::ifstream\& fin, UINT numBones, \mbox{\hyperlink{struct_bone_animation}{BoneAnimation}}\& boneAnimation)}
