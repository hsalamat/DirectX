\doxysection{Week9-\/2-\/\+Triangle\+Tessellation\+Basedon\+Distance.cpp}
...
\DoxyCodeLine{00002 \textcolor{comment}{// Triangle Tessellation}}
\DoxyCodeLine{00003 \textcolor{comment}{//Use Right mouse button to zoom in and out}}
...
\DoxyCodeLine{00052 \};}
\DoxyCodeLine{00053 }
\DoxyCodeLine{00054 \textcolor{keyword}{class }TriangleTessellationApp : \textcolor{keyword}{public} D3DApp}
\DoxyCodeLine{00055 \{}
\DoxyCodeLine{00056 \textcolor{keyword}{public}:}
\DoxyCodeLine{00057     TriangleTessellationApp(HINSTANCE hInstance);}
\DoxyCodeLine{00058     TriangleTessellationApp(\textcolor{keyword}{const} TriangleTessellationApp\& rhs) = \textcolor{keyword}{delete};}
\DoxyCodeLine{00059     TriangleTessellationApp\& operator=(\textcolor{keyword}{const} TriangleTessellationApp\& rhs) = \textcolor{keyword}{delete};}
\DoxyCodeLine{00060     \string~TriangleTessellationApp();}
\DoxyCodeLine{00061 }
...
\DoxyCodeLine{00150     \{}
\DoxyCodeLine{00151         TriangleTessellationApp theApp(hInstance);}
...
\DoxyCodeLine{00162 \}}
\DoxyCodeLine{00163 }
\DoxyCodeLine{00164 TriangleTessellationApp::TriangleTessellationApp(HINSTANCE hInstance)}
\DoxyCodeLine{00165     : D3DApp(hInstance)}
\DoxyCodeLine{00166 \{}
\DoxyCodeLine{00167 \}}
\DoxyCodeLine{00168 }
\DoxyCodeLine{00169 TriangleTessellationApp::\string~TriangleTessellationApp()}
\DoxyCodeLine{00170 \{}
\DoxyCodeLine{00171     \textcolor{keywordflow}{if} (md3dDevice != \textcolor{keyword}{nullptr})}
\DoxyCodeLine{00172         FlushCommandQueue();}
\DoxyCodeLine{00173 \}}
\DoxyCodeLine{00174 }
\DoxyCodeLine{00175 \textcolor{keywordtype}{bool} TriangleTessellationApp::Initialize()}
\DoxyCodeLine{00176 \{}
...
\DoxyCodeLine{00201 \}}
\DoxyCodeLine{00202 }
\DoxyCodeLine{00203 \textcolor{keywordtype}{void} TriangleTessellationApp::OnResize()}
\DoxyCodeLine{00204 \{}
...
\DoxyCodeLine{00216 }
\DoxyCodeLine{00217 \textcolor{keywordtype}{void} TriangleTessellationApp::Update(\textcolor{keyword}{const} GameTimer\& gt)}
\DoxyCodeLine{00218 \{}
...
\DoxyCodeLine{00240 \}}
\DoxyCodeLine{00241 }
\DoxyCodeLine{00242 \textcolor{keywordtype}{void} TriangleTessellationApp::Draw(\textcolor{keyword}{const} GameTimer\& gt)}
\DoxyCodeLine{00243 \{}
...
\DoxyCodeLine{00320 \}}
\DoxyCodeLine{00321 }
\DoxyCodeLine{00322 \textcolor{keywordtype}{void} TriangleTessellationApp::OnMouseDown(WPARAM btnState, \textcolor{keywordtype}{int} x, \textcolor{keywordtype}{int} y)}
\DoxyCodeLine{00323 \{}
...
\DoxyCodeLine{00328 \}}
\DoxyCodeLine{00329 }
\DoxyCodeLine{00330 \textcolor{keywordtype}{void} TriangleTessellationApp::OnMouseUp(WPARAM btnState, \textcolor{keywordtype}{int} x, \textcolor{keywordtype}{int} y)}
\DoxyCodeLine{00331 \{}
\DoxyCodeLine{00332     ReleaseCapture();}
\DoxyCodeLine{00333 \}}
\DoxyCodeLine{00334 }
\DoxyCodeLine{00335 \textcolor{keywordtype}{void} TriangleTessellationApp::OnMouseMove(WPARAM btnState, \textcolor{keywordtype}{int} x, \textcolor{keywordtype}{int} y)}
\DoxyCodeLine{00336 \{}
...
\DoxyCodeLine{00365 \}}
\DoxyCodeLine{00366 }
\DoxyCodeLine{00367 \textcolor{keywordtype}{void} TriangleTessellationApp::OnKeyboardInput(\textcolor{keyword}{const} GameTimer\& gt)}
\DoxyCodeLine{00368 \{}
...
\DoxyCodeLine{00379 \}}
\DoxyCodeLine{00380 }
\DoxyCodeLine{00381 \textcolor{keywordtype}{void} TriangleTessellationApp::UpdateCamera(\textcolor{keyword}{const} GameTimer\& gt)}
\DoxyCodeLine{00382 \{}
...
\DoxyCodeLine{00398 \textcolor{keywordtype}{void} TriangleTessellationApp::UpdateObjectCBs(\textcolor{keyword}{const} GameTimer\& gt)}
\DoxyCodeLine{00399 \{}
...
\DoxyCodeLine{00422 \textcolor{keywordtype}{void} TriangleTessellationApp::UpdateMainPassCB(\textcolor{keyword}{const} GameTimer\& gt)}
\DoxyCodeLine{00423 \{}
...
\DoxyCodeLine{00448 \}}
\DoxyCodeLine{00449 }
\DoxyCodeLine{00450 \textcolor{keywordtype}{void} TriangleTessellationApp::BuildDescriptorHeaps()}
\DoxyCodeLine{00451 \{}
...
\DoxyCodeLine{00468 \}}
\DoxyCodeLine{00469 }
\DoxyCodeLine{00470 \textcolor{keywordtype}{void} TriangleTessellationApp::BuildConstantBufferViews()}
\DoxyCodeLine{00471 \{}
...
\DoxyCodeLine{00519 \}}
\DoxyCodeLine{00520 }
\DoxyCodeLine{00521 \textcolor{keywordtype}{void} TriangleTessellationApp::BuildRootSignature()}
\DoxyCodeLine{00522 \{}
...
\DoxyCodeLine{00562 \}}
\DoxyCodeLine{00563 }
\DoxyCodeLine{00564 \textcolor{keywordtype}{void} TriangleTessellationApp::BuildShadersAndInputLayout()}
\DoxyCodeLine{00565 \{}
...
\DoxyCodeLine{00568 }
\DoxyCodeLine{00569     mShaders[\textcolor{stringliteral}{"{}tessHS"{}}] = d3dUtil::CompileShader(L\textcolor{stringliteral}{"{}Shaders\(\backslash\)\(\backslash\)Tessellation2.hlsl"{}}, \textcolor{keyword}{nullptr}, \textcolor{stringliteral}{"{}HS"{}}, \textcolor{stringliteral}{"{}hs\_5\_1"{}});}
\DoxyCodeLine{00570     mShaders[\textcolor{stringliteral}{"{}tessDS"{}}] = d3dUtil::CompileShader(L\textcolor{stringliteral}{"{}Shaders\(\backslash\)\(\backslash\)Tessellation2.hlsl"{}}, \textcolor{keyword}{nullptr}, \textcolor{stringliteral}{"{}DS"{}}, \textcolor{stringliteral}{"{}ds\_5\_1"{}});}
\DoxyCodeLine{00571 }
...
\DoxyCodeLine{00577 \}}
\DoxyCodeLine{00578 }
\DoxyCodeLine{00579 \textcolor{keywordtype}{void} TriangleTessellationApp::BuildShapeGeometry()}
\DoxyCodeLine{00580 \{}
\DoxyCodeLine{00581     std::array<Vertex, 3> vertices =}
\DoxyCodeLine{00582     \{}
\DoxyCodeLine{00583                 Vertex(\{ XMFLOAT3(-\/1.5f, -\/1.5f, 0.0f), XMFLOAT4(Colors::Red)\}),}
\DoxyCodeLine{00584                 Vertex(\{ XMFLOAT3(+1.5f, +1.5f, 0.0f) , XMFLOAT4(Colors::Green) \}),}
\DoxyCodeLine{00585                 Vertex(\{ XMFLOAT3(+1.5f, -\/1.5f, 0.0f) , XMFLOAT4(Colors::Blue)\}),}
\DoxyCodeLine{00586 }
\DoxyCodeLine{00587     \};}
\DoxyCodeLine{00588 }
\DoxyCodeLine{00589 }
\DoxyCodeLine{00590     std::array<std::uint16\_t, 3> indices =}
\DoxyCodeLine{00591     \{}
\DoxyCodeLine{00592 }
\DoxyCodeLine{00593         0, 1, 2}
\DoxyCodeLine{00594     \};}
\DoxyCodeLine{00595 }
\DoxyCodeLine{00596 }
\DoxyCodeLine{00597 }
\DoxyCodeLine{00598     \textcolor{keyword}{const} UINT vbByteSize = (UINT)vertices.size() * \textcolor{keyword}{sizeof}(Vertex);}
\DoxyCodeLine{00599     \textcolor{keyword}{const} UINT ibByteSize = (UINT)indices.size() * \textcolor{keyword}{sizeof}(std::uint16\_t);}
\DoxyCodeLine{00600 }
\DoxyCodeLine{00601     \textcolor{keyword}{auto} mBoxGeo = std::make\_unique<MeshGeometry>();}
\DoxyCodeLine{00602     mBoxGeo-\/>Name = \textcolor{stringliteral}{"{}shapeGeo"{}};}
\DoxyCodeLine{00603 }
\DoxyCodeLine{00604     ThrowIfFailed(D3DCreateBlob(vbByteSize, \&mBoxGeo-\/>VertexBufferCPU));}
\DoxyCodeLine{00605     CopyMemory(mBoxGeo-\/>VertexBufferCPU-\/>GetBufferPointer(), vertices.data(), vbByteSize);}
\DoxyCodeLine{00606 }
\DoxyCodeLine{00607     ThrowIfFailed(D3DCreateBlob(ibByteSize, \&mBoxGeo-\/>IndexBufferCPU));}
\DoxyCodeLine{00608     CopyMemory(mBoxGeo-\/>IndexBufferCPU-\/>GetBufferPointer(), indices.data(), ibByteSize);}
\DoxyCodeLine{00609 }
\DoxyCodeLine{00610     mBoxGeo-\/>VertexBufferGPU = d3dUtil::CreateDefaultBuffer(md3dDevice.Get(),}
\DoxyCodeLine{00611         mCommandList.Get(), vertices.data(), vbByteSize, mBoxGeo-\/>VertexBufferUploader);}
\DoxyCodeLine{00612 }
\DoxyCodeLine{00613     mBoxGeo-\/>IndexBufferGPU = d3dUtil::CreateDefaultBuffer(md3dDevice.Get(),}
\DoxyCodeLine{00614         mCommandList.Get(), indices.data(), ibByteSize, mBoxGeo-\/>IndexBufferUploader);}
\DoxyCodeLine{00615 }
\DoxyCodeLine{00616     mBoxGeo-\/>VertexByteStride = \textcolor{keyword}{sizeof}(Vertex);}
\DoxyCodeLine{00617     mBoxGeo-\/>VertexBufferByteSize = vbByteSize;}
\DoxyCodeLine{00618     mBoxGeo-\/>IndexFormat = DXGI\_FORMAT\_R16\_UINT;}
\DoxyCodeLine{00619     mBoxGeo-\/>IndexBufferByteSize = ibByteSize;}
\DoxyCodeLine{00620 }
\DoxyCodeLine{00621     SubmeshGeometry submesh;}
\DoxyCodeLine{00622     submesh.IndexCount = (UINT)indices.size();}
\DoxyCodeLine{00623     submesh.StartIndexLocation = 0;}
\DoxyCodeLine{00624     submesh.BaseVertexLocation = 0;}
\DoxyCodeLine{00625 }
\DoxyCodeLine{00626     mBoxGeo-\/>DrawArgs[\textcolor{stringliteral}{"{}box"{}}] = submesh;}
\DoxyCodeLine{00627 }
\DoxyCodeLine{00628 }
\DoxyCodeLine{00629     mGeometries[mBoxGeo-\/>Name] = std::move(mBoxGeo);}
\DoxyCodeLine{00630 }
\DoxyCodeLine{00631 \}}
\DoxyCodeLine{00632 }
\DoxyCodeLine{00633 \textcolor{keywordtype}{void} TriangleTessellationApp::BuildPSOs()}
\DoxyCodeLine{00634 \{}
\DoxyCodeLine{00635     D3D12\_GRAPHICS\_PIPELINE\_STATE\_DESC opaquePsoDesc;}
\DoxyCodeLine{00636 }
\DoxyCodeLine{00637     \textcolor{comment}{//}}
\DoxyCodeLine{00638     \textcolor{comment}{// PSO for opaque objects.}}
\DoxyCodeLine{00639     \textcolor{comment}{//}}
\DoxyCodeLine{00640     ZeroMemory(\&opaquePsoDesc, \textcolor{keyword}{sizeof}(D3D12\_GRAPHICS\_PIPELINE\_STATE\_DESC));}
\DoxyCodeLine{00641     opaquePsoDesc.InputLayout = \{ mInputLayout.data(), (UINT)mInputLayout.size() \};}
\DoxyCodeLine{00642     opaquePsoDesc.pRootSignature = mRootSignature.Get();}
\DoxyCodeLine{00643     opaquePsoDesc.VS =}
\DoxyCodeLine{00644     \{}
\DoxyCodeLine{00645         \textcolor{keyword}{reinterpret\_cast<}BYTE*\textcolor{keyword}{>}(mShaders[\textcolor{stringliteral}{"{}standardVS"{}}]-\/>GetBufferPointer()),}
\DoxyCodeLine{00646         mShaders[\textcolor{stringliteral}{"{}standardVS"{}}]-\/>GetBufferSize()}
\DoxyCodeLine{00647     \};}
\DoxyCodeLine{00648     opaquePsoDesc.PS =}
\DoxyCodeLine{00649     \{}
\DoxyCodeLine{00650         \textcolor{keyword}{reinterpret\_cast<}BYTE*\textcolor{keyword}{>}(mShaders[\textcolor{stringliteral}{"{}opaquePS"{}}]-\/>GetBufferPointer()),}
\DoxyCodeLine{00651         mShaders[\textcolor{stringliteral}{"{}opaquePS"{}}]-\/>GetBufferSize()}
\DoxyCodeLine{00652     \};}
\DoxyCodeLine{00653 }
\DoxyCodeLine{00654     opaquePsoDesc.HS =}
\DoxyCodeLine{00655     \{}
\DoxyCodeLine{00656         \textcolor{keyword}{reinterpret\_cast<}BYTE*\textcolor{keyword}{>}(mShaders[\textcolor{stringliteral}{"{}tessHS"{}}]-\/>GetBufferPointer()),}
\DoxyCodeLine{00657         mShaders[\textcolor{stringliteral}{"{}tessHS"{}}]-\/>GetBufferSize()}
\DoxyCodeLine{00658     \};}
\DoxyCodeLine{00659     opaquePsoDesc.DS =}
\DoxyCodeLine{00660     \{}
\DoxyCodeLine{00661         \textcolor{keyword}{reinterpret\_cast<}BYTE*\textcolor{keyword}{>}(mShaders[\textcolor{stringliteral}{"{}tessDS"{}}]-\/>GetBufferPointer()),}
\DoxyCodeLine{00662         mShaders[\textcolor{stringliteral}{"{}tessDS"{}}]-\/>GetBufferSize()}
\DoxyCodeLine{00663     \};}
\DoxyCodeLine{00664 }
\DoxyCodeLine{00665     opaquePsoDesc.RasterizerState = CD3DX12\_RASTERIZER\_DESC(D3D12\_DEFAULT);}
\DoxyCodeLine{00666     opaquePsoDesc.RasterizerState.FillMode = D3D12\_FILL\_MODE\_WIREFRAME;}
...
\DoxyCodeLine{00670     opaquePsoDesc.PrimitiveTopologyType = D3D12\_PRIMITIVE\_TOPOLOGY\_TYPE\_PATCH;}
...
\DoxyCodeLine{00676     ThrowIfFailed(md3dDevice-\/>CreateGraphicsPipelineState(\&opaquePsoDesc, IID\_PPV\_ARGS(\&mPSOs[\textcolor{stringliteral}{"{}opaque"{}}])));}
\DoxyCodeLine{00677 }
\DoxyCodeLine{00678 }
\DoxyCodeLine{00679     \textcolor{comment}{//}}
\DoxyCodeLine{00680     \textcolor{comment}{// PSO for opaque wireframe objects.}}
\DoxyCodeLine{00681     \textcolor{comment}{//}}
\DoxyCodeLine{00682 }
\DoxyCodeLine{00683     D3D12\_GRAPHICS\_PIPELINE\_STATE\_DESC opaqueWireframePsoDesc = opaquePsoDesc;}
\DoxyCodeLine{00684     opaqueWireframePsoDesc.RasterizerState.FillMode = D3D12\_FILL\_MODE\_SOLID;}
\DoxyCodeLine{00685     ThrowIfFailed(md3dDevice-\/>CreateGraphicsPipelineState(\&opaqueWireframePsoDesc, IID\_PPV\_ARGS(\&mPSOs[\textcolor{stringliteral}{"{}opaque\_wireframe"{}}])));}
\DoxyCodeLine{00686 \}}
\DoxyCodeLine{00687 }
\DoxyCodeLine{00688 }
\DoxyCodeLine{00689 \textcolor{keywordtype}{void} TriangleTessellationApp::BuildFrameResources()}
\DoxyCodeLine{00690 \{}
...
\DoxyCodeLine{00694             1, (UINT)mAllRitems.size()));}
\DoxyCodeLine{00695     \}}
\DoxyCodeLine{00696 \}}
\DoxyCodeLine{00697 }
\DoxyCodeLine{00698 \textcolor{keywordtype}{void} TriangleTessellationApp::BuildRenderItems()}
\DoxyCodeLine{00699 \{}
\DoxyCodeLine{00700     \textcolor{keyword}{auto} boxRitem = std::make\_unique<RenderItem>();}
\DoxyCodeLine{00701     XMStoreFloat4x4(\&boxRitem-\/>World, XMMatrixScaling(2.0f, 2.0f, 2.0f) * XMMatrixTranslation(0.0f, 0.5f, 0.0f));}
\DoxyCodeLine{00702     boxRitem-\/>ObjCBIndex = 0;}
\DoxyCodeLine{00703     boxRitem-\/>Geo = mGeometries[\textcolor{stringliteral}{"{}shapeGeo"{}}].get();}
\DoxyCodeLine{00704     boxRitem-\/>PrimitiveType = D3D\_PRIMITIVE\_TOPOLOGY\_3\_CONTROL\_POINT\_PATCHLIST;}
\DoxyCodeLine{00705     boxRitem-\/>IndexCount = boxRitem-\/>Geo-\/>DrawArgs[\textcolor{stringliteral}{"{}box"{}}].IndexCount;  \textcolor{comment}{//36}}
\DoxyCodeLine{00706     boxRitem-\/>StartIndexLocation = boxRitem-\/>Geo-\/>DrawArgs[\textcolor{stringliteral}{"{}box"{}}].StartIndexLocation; \textcolor{comment}{//0}}
\DoxyCodeLine{00707     boxRitem-\/>BaseVertexLocation = boxRitem-\/>Geo-\/>DrawArgs[\textcolor{stringliteral}{"{}box"{}}].BaseVertexLocation; \textcolor{comment}{//0}}
\DoxyCodeLine{00708     mAllRitems.push\_back(std::move(boxRitem));}
\DoxyCodeLine{00709 }
\DoxyCodeLine{00710 }
\DoxyCodeLine{00711     \textcolor{comment}{// All the render items are opaque.}}
\DoxyCodeLine{00712     \textcolor{comment}{//Our application will maintain lists of render items based on how they need to be}}
\DoxyCodeLine{00713     \textcolor{comment}{//drawn; that is, render items that need different PSOs will be kept in different lists.}}
\DoxyCodeLine{00714     \textcolor{keywordflow}{for} (\textcolor{keyword}{auto}\& e : mAllRitems)}
\DoxyCodeLine{00715         mOpaqueRitems.push\_back(e.get());}
\DoxyCodeLine{00716 \}}
\DoxyCodeLine{00717 }
\DoxyCodeLine{00718 \textcolor{keywordtype}{void} TriangleTessellationApp::DrawRenderItems(ID3D12GraphicsCommandList* cmdList, \textcolor{keyword}{const} std::vector<RenderItem*>\& ritems)}
\DoxyCodeLine{00719 \{}
\DoxyCodeLine{00720     UINT objCBByteSize = d3dUtil::CalcConstantBufferByteSize(\textcolor{keyword}{sizeof}(ObjectConstants));}
\DoxyCodeLine{00721 }
\DoxyCodeLine{00722     \textcolor{keyword}{auto} objectCB = mCurrFrameResource-\/>ObjectCB-\/>Resource();}
\DoxyCodeLine{00723 }
\DoxyCodeLine{00724     \textcolor{comment}{// For each render item...}}
\DoxyCodeLine{00725     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{size\_t} i = 0; i < ritems.size(); ++i)}
\DoxyCodeLine{00726     \{}
\DoxyCodeLine{00727         \textcolor{keyword}{auto} ri = ritems[i];}
\DoxyCodeLine{00728 }
\DoxyCodeLine{00729         cmdList-\/>IASetVertexBuffers(0, 1, \&ri-\/>Geo-\/>VertexBufferView());}
\DoxyCodeLine{00730         cmdList-\/>IASetIndexBuffer(\&ri-\/>Geo-\/>IndexBufferView());}
\DoxyCodeLine{00731         cmdList-\/>IASetPrimitiveTopology(ri-\/>PrimitiveType);}
\DoxyCodeLine{00732 }
\DoxyCodeLine{00733         \textcolor{comment}{// Offset to the CBV in the descriptor heap for this object and for this frame resource.}}
\DoxyCodeLine{00734         UINT cbvIndex = mCurrFrameResourceIndex * (UINT)mOpaqueRitems.size() + ri-\/>ObjCBIndex;}
\DoxyCodeLine{00735         \textcolor{keyword}{auto} cbvHandle = CD3DX12\_GPU\_DESCRIPTOR\_HANDLE(mCbvHeap-\/>GetGPUDescriptorHandleForHeapStart());}
\DoxyCodeLine{00736         cbvHandle.Offset(cbvIndex, mCbvSrvUavDescriptorSize);}
\DoxyCodeLine{00737 }
\DoxyCodeLine{00738         cmdList-\/>SetGraphicsRootDescriptorTable(0, cbvHandle);}
\DoxyCodeLine{00739 }
\DoxyCodeLine{00740         cmdList-\/>DrawIndexedInstanced(ri-\/>IndexCount, 1, ri-\/>StartIndexLocation, ri-\/>BaseVertexLocation, 0);}
\DoxyCodeLine{00741     \}}
\DoxyCodeLine{00742 \}}
\DoxyCodeLine{00743 }
\DoxyCodeLine{00744 }
