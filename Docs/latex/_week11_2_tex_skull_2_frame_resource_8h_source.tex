...
\DoxyCodeLine{00044     DirectX::XMFLOAT2 TexC;}
\DoxyCodeLine{00045 \};}
\DoxyCodeLine{00046 }
...
\DoxyCodeLine{00049 \textcolor{keyword}{struct }FrameResource}
\DoxyCodeLine{00050 \{}
\DoxyCodeLine{00051 \textcolor{keyword}{public}:}
\DoxyCodeLine{00052     }
\DoxyCodeLine{00053     FrameResource(ID3D12Device* device, UINT passCount, UINT objectCount, UINT materialCount);}
\DoxyCodeLine{00054     FrameResource(\textcolor{keyword}{const} FrameResource\& rhs) = \textcolor{keyword}{delete};}
\DoxyCodeLine{00055     FrameResource\& operator=(\textcolor{keyword}{const} FrameResource\& rhs) = \textcolor{keyword}{delete};}
\DoxyCodeLine{00056     \string~FrameResource();}
\DoxyCodeLine{00057 }
...
\DoxyCodeLine{00060     Microsoft::WRL::ComPtr<ID3D12CommandAllocator> CmdListAlloc;}
\DoxyCodeLine{00061 }
...
\DoxyCodeLine{00065     std::unique\_ptr<UploadBuffer<PassConstants>> PassCB = \textcolor{keyword}{nullptr};}
\DoxyCodeLine{00066     std::unique\_ptr<UploadBuffer<MaterialConstants>> MaterialCB = \textcolor{keyword}{nullptr};}
\DoxyCodeLine{00067     std::unique\_ptr<UploadBuffer<ObjectConstants>> ObjectCB = \textcolor{keyword}{nullptr};}
\DoxyCodeLine{00068 }
...
\DoxyCodeLine{00071     UINT64 Fence = 0;}
\DoxyCodeLine{00072 \};}
