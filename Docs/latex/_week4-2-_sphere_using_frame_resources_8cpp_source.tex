...
\DoxyCodeLine{00002 \textcolor{comment}{// Sphere Using Frame Resources}}
...
\DoxyCodeLine{00584 \{}
\DoxyCodeLine{00585     \textcolor{comment}{//GeometryGenerator is a utility class for generating simple geometric shapes like grids, sphere, spheres, and boxes}}
...
\DoxyCodeLine{00588 }
\DoxyCodeLine{00589     \textcolor{comment}{//GeometryGenerator::CreateSphere(float radius, uint32 sliceCount, uint32 stackCount)}}
\DoxyCodeLine{00590     GeometryGenerator::MeshData sphere = geoGen.CreateSphere(0.5f, 20, 20);}
\DoxyCodeLine{00591 }
\DoxyCodeLine{00592 }
\DoxyCodeLine{00593 }
...
\DoxyCodeLine{00609 }
\DoxyCodeLine{00610     SubmeshGeometry sphereSubmesh;}
\DoxyCodeLine{00611     sphereSubmesh.IndexCount = (UINT)sphere.Indices32.size();}
\DoxyCodeLine{00612     sphereSubmesh.StartIndexLocation = sphereIndexOffset;}
\DoxyCodeLine{00613     sphereSubmesh.BaseVertexLocation = sphereVertexOffset;}
\DoxyCodeLine{00614 }
\DoxyCodeLine{00615 }
...
\DoxyCodeLine{00620 }
\DoxyCodeLine{00621     \textcolor{keyword}{auto} totalVertexCount = sphere.Vertices.size();}
\DoxyCodeLine{00622 }
\DoxyCodeLine{00623 }
\DoxyCodeLine{00624     std::vector<Vertex> vertices(totalVertexCount);}
\DoxyCodeLine{00625 }
\DoxyCodeLine{00626     UINT k = 0;}
\DoxyCodeLine{00627     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{size\_t} i = 0; i < sphere.Vertices.size(); ++i, ++k)}
\DoxyCodeLine{00628     \{}
\DoxyCodeLine{00629         vertices[k].Pos = sphere.Vertices[i].Position;}
...
\DoxyCodeLine{00635     indices.insert(indices.end(), std::begin(sphere.GetIndices16()), std::end(sphere.GetIndices16()));}
\DoxyCodeLine{00636 }
\DoxyCodeLine{00637 }
...
\DoxyCodeLine{00723 \{}
\DoxyCodeLine{00724     \textcolor{keyword}{auto} sphereRitem = std::make\_unique<RenderItem>();}
\DoxyCodeLine{00725     XMStoreFloat4x4(\&sphereRitem-\/>World, XMMatrixScaling(2.0f, 2.0f, 2.0f) * XMMatrixTranslation(0.0f, 0.5f, 0.0f));}
\DoxyCodeLine{00726     sphereRitem-\/>ObjCBIndex = 0;}
\DoxyCodeLine{00727     sphereRitem-\/>Geo = mGeometries[\textcolor{stringliteral}{"{}shapeGeo"{}}].get();}
\DoxyCodeLine{00728     sphereRitem-\/>PrimitiveType = D3D\_PRIMITIVE\_TOPOLOGY\_TRIANGLELIST;}
\DoxyCodeLine{00729     sphereRitem-\/>IndexCount = sphereRitem-\/>Geo-\/>DrawArgs[\textcolor{stringliteral}{"{}sphere"{}}].IndexCount;  \textcolor{comment}{//2280}}
\DoxyCodeLine{00730     sphereRitem-\/>StartIndexLocation = sphereRitem-\/>Geo-\/>DrawArgs[\textcolor{stringliteral}{"{}sphere"{}}].StartIndexLocation; \textcolor{comment}{//0}}
\DoxyCodeLine{00731     sphereRitem-\/>BaseVertexLocation = sphereRitem-\/>Geo-\/>DrawArgs[\textcolor{stringliteral}{"{}sphere"{}}].BaseVertexLocation; \textcolor{comment}{//0}}
\DoxyCodeLine{00732     mAllRitems.push\_back(std::move(sphereRitem));}
\DoxyCodeLine{00733 }
\DoxyCodeLine{00734 }
