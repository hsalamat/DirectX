...
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00026}00026     LoadPipeline();}
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00027}00027     LoadAssets();}
...
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00031}00031 \textcolor{keywordtype}{void} D3D12HelloTriangle::LoadPipeline()}
...
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00061}00061             IID\_PPV\_ARGS(\&m\_device)}
...
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00072}00072             IID\_PPV\_ARGS(\&m\_device)}
...
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00081}00081     \mbox{\hyperlink{d3d_util_8h_af3892d76181a8a44edbd1a71a6ae9b97}{ThrowIfFailed}}(m\_device-\/>CreateCommandQueue(\&queueDesc, IID\_PPV\_ARGS(\&m\_commandQueue)));}
...
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00085}00085     swapChainDesc.BufferCount = FrameCount;}
...
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00096}00096         m\_commandQueue.Get(),        \textcolor{comment}{// Swap chain needs the queue so that it can force a flush on it.}}
...
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00107}00107     \mbox{\hyperlink{d3d_util_8h_af3892d76181a8a44edbd1a71a6ae9b97}{ThrowIfFailed}}(swapChain.As(\&m\_swapChain));}
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00108}00108     m\_frameIndex = m\_swapChain-\/>GetCurrentBackBufferIndex();}
...
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00114}00114         rtvHeapDesc.NumDescriptors = FrameCount;}
...
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00117}00117         \mbox{\hyperlink{d3d_util_8h_af3892d76181a8a44edbd1a71a6ae9b97}{ThrowIfFailed}}(m\_device-\/>CreateDescriptorHeap(\&rtvHeapDesc, IID\_PPV\_ARGS(\&m\_rtvHeap)));}
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00118}00118 }
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00119}00119         m\_rtvDescriptorSize = m\_device-\/>GetDescriptorHandleIncrementSize(D3D12\_DESCRIPTOR\_HEAP\_TYPE\_RTV);}
...
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00124}00124         CD3DX12\_CPU\_DESCRIPTOR\_HANDLE rtvHandle(m\_rtvHeap-\/>GetCPUDescriptorHandleForHeapStart());}
...
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00127}00127         \textcolor{keywordflow}{for} (UINT n = 0; n < FrameCount; n++)}
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00128}00128         \{}
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00129}00129             \mbox{\hyperlink{d3d_util_8h_af3892d76181a8a44edbd1a71a6ae9b97}{ThrowIfFailed}}(m\_swapChain-\/>GetBuffer(n, IID\_PPV\_ARGS(\&m\_renderTargets[n])));}
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00130}00130             m\_device-\/>CreateRenderTargetView(m\_renderTargets[n].Get(), \textcolor{keyword}{nullptr}, rtvHandle);}
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00131}00131             rtvHandle.Offset(1, m\_rtvDescriptorSize);}
...
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00135}00135     \mbox{\hyperlink{d3d_util_8h_af3892d76181a8a44edbd1a71a6ae9b97}{ThrowIfFailed}}(m\_device-\/>CreateCommandAllocator(D3D12\_COMMAND\_LIST\_TYPE\_DIRECT, IID\_PPV\_ARGS(\&m\_commandAllocator)));}
...
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00139}00139 \textcolor{keywordtype}{void} D3D12HelloTriangle::LoadAssets()}
...
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00150}00150         \mbox{\hyperlink{d3d_util_8h_af3892d76181a8a44edbd1a71a6ae9b97}{ThrowIfFailed}}(m\_device-\/>CreateRootSignature(0, signature-\/>GetBufferPointer(), signature-\/>GetBufferSize(), IID\_PPV\_ARGS(\&m\_rootSignature)));}
...
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00186}00186         psoDesc.pRootSignature = m\_rootSignature.Get();}
...
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00198}00198         \mbox{\hyperlink{d3d_util_8h_af3892d76181a8a44edbd1a71a6ae9b97}{ThrowIfFailed}}(m\_device-\/>CreateGraphicsPipelineState(\&psoDesc, IID\_PPV\_ARGS(\&m\_pipelineState)));}
...
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00202}00202     \mbox{\hyperlink{d3d_util_8h_af3892d76181a8a44edbd1a71a6ae9b97}{ThrowIfFailed}}(m\_device-\/>CreateCommandList(0, D3D12\_COMMAND\_LIST\_TYPE\_DIRECT, m\_commandAllocator.Get(), m\_pipelineState.Get(), IID\_PPV\_ARGS(\&m\_commandList)));}
...
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00206}00206     \mbox{\hyperlink{d3d_util_8h_af3892d76181a8a44edbd1a71a6ae9b97}{ThrowIfFailed}}(m\_commandList-\/>Close());}
...
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00211}00211         \mbox{\hyperlink{struct_vertex}{Vertex}} triangleVertices[] =}
...
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00233}00233         \mbox{\hyperlink{d3d_util_8h_af3892d76181a8a44edbd1a71a6ae9b97}{ThrowIfFailed}}(m\_device-\/>CreateCommittedResource(}
...
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00239}00239             IID\_PPV\_ARGS(\&m\_vertexBuffer)));}
...
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00244}00244         \mbox{\hyperlink{d3d_util_8h_af3892d76181a8a44edbd1a71a6ae9b97}{ThrowIfFailed}}(m\_vertexBuffer-\/>Map(0, \&readRange, \textcolor{keyword}{reinterpret\_cast<}\textcolor{keywordtype}{void}**\textcolor{keyword}{>}(\&pVertexDataBegin)));}
...
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00246}00246         m\_vertexBuffer-\/>Unmap(0, \textcolor{keyword}{nullptr});}
...
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00249}00249         m\_vertexBufferView.BufferLocation = m\_vertexBuffer-\/>GetGPUVirtualAddress();}
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00250}00250         m\_vertexBufferView.StrideInBytes = \textcolor{keyword}{sizeof}(\mbox{\hyperlink{struct_vertex}{Vertex}});}
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00251}00251         m\_vertexBufferView.SizeInBytes = vertexBufferSize;}
...
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00257}00257         \mbox{\hyperlink{d3d_util_8h_af3892d76181a8a44edbd1a71a6ae9b97}{ThrowIfFailed}}(m\_device-\/>CreateFence(0, D3D12\_FENCE\_FLAG\_NONE, IID\_PPV\_ARGS(\&m\_fence)));}
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00258}00258         m\_fenceValue = 1;}
...
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00261}00261         m\_fenceEvent = CreateEvent(\textcolor{keyword}{nullptr}, FALSE, FALSE, \textcolor{keyword}{nullptr});}
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00262}00262         \textcolor{keywordflow}{if} (m\_fenceEvent == \textcolor{keyword}{nullptr})}
...
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00270}00270         WaitForPreviousFrame();}
...
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00285}00285     PopulateCommandList();}
...
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00288}00288     ID3D12CommandList* ppCommandLists[] = \{ m\_commandList.Get() \};}
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00289}00289     m\_commandQueue-\/>ExecuteCommandLists(\_countof(ppCommandLists), ppCommandLists);}
...
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00294}00294     \mbox{\hyperlink{d3d_util_8h_af3892d76181a8a44edbd1a71a6ae9b97}{ThrowIfFailed}}(m\_swapChain-\/>Present(1, 0));}
...
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00297}00297     WaitForPreviousFrame();}
...
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00306}00306     WaitForPreviousFrame();}
...
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00309}00309     CloseHandle(m\_fenceEvent);}
...
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00312}00312 \textcolor{keywordtype}{void} D3D12HelloTriangle::PopulateCommandList()}
...
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00317}00317     \mbox{\hyperlink{d3d_util_8h_af3892d76181a8a44edbd1a71a6ae9b97}{ThrowIfFailed}}(m\_commandAllocator-\/>Reset());}
...
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00322}00322     \mbox{\hyperlink{d3d_util_8h_af3892d76181a8a44edbd1a71a6ae9b97}{ThrowIfFailed}}(m\_commandList-\/>Reset(m\_commandAllocator.Get(), m\_pipelineState.Get()));}
...
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00325}00325     m\_commandList-\/>SetGraphicsRootSignature(m\_rootSignature.Get());}
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00326}00326     m\_commandList-\/>RSSetViewports(1, \&m\_viewport);}
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00327}00327     m\_commandList-\/>RSSetScissorRects(1, \&m\_scissorRect);}
...
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00330}00330     m\_commandList-\/>ResourceBarrier(1, \&CD3DX12\_RESOURCE\_BARRIER::Transition(m\_renderTargets[m\_frameIndex].Get(), D3D12\_RESOURCE\_STATE\_PRESENT, D3D12\_RESOURCE\_STATE\_RENDER\_TARGET));}
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00331}00331 }
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00332}00332     CD3DX12\_CPU\_DESCRIPTOR\_HANDLE rtvHandle(m\_rtvHeap-\/>GetCPUDescriptorHandleForHeapStart(), m\_frameIndex, m\_rtvDescriptorSize);}
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00333}00333     m\_commandList-\/>OMSetRenderTargets(1, \&rtvHandle, FALSE, \textcolor{keyword}{nullptr});}
...
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00339}00339     m\_commandList-\/>ClearRenderTargetView(rtvHandle, clearColor, 0, \textcolor{keyword}{nullptr});}
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00340}00340 }
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00341}00341     m\_commandList-\/>IASetPrimitiveTopology(D3D\_PRIMITIVE\_TOPOLOGY\_TRIANGLELIST);}
...
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00343}00343     m\_commandList-\/>IASetVertexBuffers(0, 1, \&m\_vertexBufferView);}
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00344}00344     m\_commandList-\/>DrawInstanced(9, 1, 0, 0);}
...
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00348}00348     m\_commandList-\/>ResourceBarrier(1, \&CD3DX12\_RESOURCE\_BARRIER::Transition(m\_renderTargets[m\_frameIndex].Get(), D3D12\_RESOURCE\_STATE\_RENDER\_TARGET, D3D12\_RESOURCE\_STATE\_PRESENT));}
...
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00351}00351     \mbox{\hyperlink{d3d_util_8h_af3892d76181a8a44edbd1a71a6ae9b97}{ThrowIfFailed}}(m\_commandList-\/>Close());}
...
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00354}00354 \textcolor{keywordtype}{void} D3D12HelloTriangle::WaitForPreviousFrame()}
...
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00362}00362     \textcolor{keyword}{const} UINT64 fence = m\_fenceValue;}
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00363}00363     \mbox{\hyperlink{d3d_util_8h_af3892d76181a8a44edbd1a71a6ae9b97}{ThrowIfFailed}}(m\_commandQueue-\/>Signal(m\_fence.Get(), fence));}
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00364}00364     m\_fenceValue++;}
...
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00367}00367     \textcolor{keywordflow}{if} (m\_fence-\/>GetCompletedValue() < fence)}
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00368}00368     \{}
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00369}00369         \mbox{\hyperlink{d3d_util_8h_af3892d76181a8a44edbd1a71a6ae9b97}{ThrowIfFailed}}(m\_fence-\/>SetEventOnCompletion(fence, m\_fenceEvent));}
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00370}00370         WaitForSingleObject(m\_fenceEvent, INFINITE);}
...
\DoxyCodeLine{\Hypertarget{_d3_d12_hello_triangle_8cpp_source_l00374}00374     m\_frameIndex = m\_swapChain-\/>GetCurrentBackBufferIndex();}
