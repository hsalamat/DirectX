...
\DoxyCodeLine{00051     }
\DoxyCodeLine{00052     FrameResource(ID3D12Device* device, UINT passCount, UINT objectCount, UINT materialCount, UINT waveVertCount);}
...
\DoxyCodeLine{00067 }
\DoxyCodeLine{00068     \textcolor{comment}{// We cannot update a dynamic vertex buffer until the GPU is done processing}}
\DoxyCodeLine{00069     \textcolor{comment}{// the commands that reference it.  So each frame needs their own.}}
\DoxyCodeLine{00070     std::unique\_ptr<UploadBuffer<Vertex>> WavesVB = \textcolor{keyword}{nullptr};}
\DoxyCodeLine{00071 }
\DoxyCodeLine{00072     \textcolor{comment}{// Fence value to mark commands up to this fence point.  This lets us}}
\DoxyCodeLine{00073     \textcolor{comment}{// check if these frame resources are still in use by the GPU.}}
\DoxyCodeLine{00074     UINT64 Fence = 0;}
\DoxyCodeLine{00075 \};}
