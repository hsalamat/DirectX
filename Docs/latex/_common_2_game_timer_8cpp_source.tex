...
\DoxyCodeLine{\Hypertarget{_common_2_game_timer_8cpp_source_l00014}00014     \mbox{\hyperlink{class_game_timer_a328b88357900be43047dbffe8f874ff5}{mSecondsPerCount}} = 1.0 / (double)countsPerSec;}
...
\DoxyCodeLine{\Hypertarget{_common_2_game_timer_8cpp_source_l00053}00053     \textcolor{keywordflow}{return} (\textcolor{keywordtype}{float})\mbox{\hyperlink{class_game_timer_ac1082a00c6b98bf0b0976682547445cb}{mDeltaTime}};}
...
\DoxyCodeLine{\Hypertarget{_common_2_game_timer_8cpp_source_l00061}00061     \mbox{\hyperlink{class_game_timer_a424093031f26d448ad23ec7f7a19e608}{mBaseTime}} = currTime;}
\DoxyCodeLine{\Hypertarget{_common_2_game_timer_8cpp_source_l00062}00062     \mbox{\hyperlink{class_game_timer_a9fb99d6fd14d65a95a3c3bdc015953eb}{mPrevTime}} = currTime;}
\DoxyCodeLine{\Hypertarget{_common_2_game_timer_8cpp_source_l00063}00063     \mbox{\hyperlink{class_game_timer_a77f397ebc6ed463721bedd6a4d9ea8cb}{mStopTime}} = 0;}
\DoxyCodeLine{\Hypertarget{_common_2_game_timer_8cpp_source_l00064}00064     \mbox{\hyperlink{class_game_timer_a12b856fa54aa26a4a6a0b22a7c0387a7}{mStopped}}  = \textcolor{keyword}{false};}
...
\DoxyCodeLine{\Hypertarget{_common_2_game_timer_8cpp_source_l00079}00079     \textcolor{keywordflow}{if}( \mbox{\hyperlink{class_game_timer_a12b856fa54aa26a4a6a0b22a7c0387a7}{mStopped}} )}
\DoxyCodeLine{\Hypertarget{_common_2_game_timer_8cpp_source_l00080}00080     \{}
\DoxyCodeLine{\Hypertarget{_common_2_game_timer_8cpp_source_l00081}00081         \mbox{\hyperlink{class_game_timer_adbeb5a6c41217856b457b4ccc750dcc7}{mPausedTime}} += (startTime -\/ \mbox{\hyperlink{class_game_timer_a77f397ebc6ed463721bedd6a4d9ea8cb}{mStopTime}}); }
\DoxyCodeLine{\Hypertarget{_common_2_game_timer_8cpp_source_l00082}00082 }
\DoxyCodeLine{\Hypertarget{_common_2_game_timer_8cpp_source_l00083}00083         \mbox{\hyperlink{class_game_timer_a9fb99d6fd14d65a95a3c3bdc015953eb}{mPrevTime}} = startTime;}
\DoxyCodeLine{\Hypertarget{_common_2_game_timer_8cpp_source_l00084}00084         \mbox{\hyperlink{class_game_timer_a77f397ebc6ed463721bedd6a4d9ea8cb}{mStopTime}} = 0;}
\DoxyCodeLine{\Hypertarget{_common_2_game_timer_8cpp_source_l00085}00085         \mbox{\hyperlink{class_game_timer_a12b856fa54aa26a4a6a0b22a7c0387a7}{mStopped}}  = \textcolor{keyword}{false};}
...
\DoxyCodeLine{\Hypertarget{_common_2_game_timer_8cpp_source_l00091}00091     \textcolor{keywordflow}{if}( !\mbox{\hyperlink{class_game_timer_a12b856fa54aa26a4a6a0b22a7c0387a7}{mStopped}} )}
...
\DoxyCodeLine{\Hypertarget{_common_2_game_timer_8cpp_source_l00096}00096         \mbox{\hyperlink{class_game_timer_a77f397ebc6ed463721bedd6a4d9ea8cb}{mStopTime}} = currTime;}
\DoxyCodeLine{\Hypertarget{_common_2_game_timer_8cpp_source_l00097}00097         \mbox{\hyperlink{class_game_timer_a12b856fa54aa26a4a6a0b22a7c0387a7}{mStopped}}  = \textcolor{keyword}{true};}
...
\DoxyCodeLine{\Hypertarget{_common_2_game_timer_8cpp_source_l00103}00103     \textcolor{keywordflow}{if}( \mbox{\hyperlink{class_game_timer_a12b856fa54aa26a4a6a0b22a7c0387a7}{mStopped}} )}
\DoxyCodeLine{\Hypertarget{_common_2_game_timer_8cpp_source_l00104}00104     \{}
\DoxyCodeLine{\Hypertarget{_common_2_game_timer_8cpp_source_l00105}00105         \mbox{\hyperlink{class_game_timer_ac1082a00c6b98bf0b0976682547445cb}{mDeltaTime}} = 0.0;}
...
\DoxyCodeLine{\Hypertarget{_common_2_game_timer_8cpp_source_l00111}00111     \mbox{\hyperlink{class_game_timer_a27ead1553e2bf00184be52df7fd3ea53}{mCurrTime}} = currTime;}
...
\DoxyCodeLine{\Hypertarget{_common_2_game_timer_8cpp_source_l00117}00117     \mbox{\hyperlink{class_game_timer_a9fb99d6fd14d65a95a3c3bdc015953eb}{mPrevTime}} = \mbox{\hyperlink{class_game_timer_a27ead1553e2bf00184be52df7fd3ea53}{mCurrTime}};}
...
\DoxyCodeLine{\Hypertarget{_common_2_game_timer_8cpp_source_l00122}00122     \textcolor{keywordflow}{if}(\mbox{\hyperlink{class_game_timer_ac1082a00c6b98bf0b0976682547445cb}{mDeltaTime}} < 0.0)}
\DoxyCodeLine{\Hypertarget{_common_2_game_timer_8cpp_source_l00123}00123     \{}
\DoxyCodeLine{\Hypertarget{_common_2_game_timer_8cpp_source_l00124}00124         \mbox{\hyperlink{class_game_timer_ac1082a00c6b98bf0b0976682547445cb}{mDeltaTime}} = 0.0;}
