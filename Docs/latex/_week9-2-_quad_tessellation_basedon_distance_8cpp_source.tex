\doxysection{Week9-\/2-\/\+Quad\+Tessellation\+Basedon\+Distance.cpp}
...
\DoxyCodeLine{00577 \}}
\DoxyCodeLine{00578 }
\DoxyCodeLine{00579 \textcolor{keywordtype}{void} ShapesApp::BuildShapeGeometry()}
\DoxyCodeLine{00580 \{}
\DoxyCodeLine{00581     std::array<Vertex, 4> vertices =}
\DoxyCodeLine{00582     \{}
\DoxyCodeLine{00583                 Vertex(\{ XMFLOAT3(-\/2.0f, -\/2.0f, 0.0f), XMFLOAT4(Colors::Red)\}),}
\DoxyCodeLine{00584                 Vertex(\{ XMFLOAT3(-\/2.0f, +2.0f, 0.0f) , XMFLOAT4(Colors::Green) \}),}
\DoxyCodeLine{00585                 Vertex(\{ XMFLOAT3(+2.0f, -\/2.0f, 0.0f) , XMFLOAT4(Colors::Cyan)\}),}
\DoxyCodeLine{00586                 Vertex(\{ XMFLOAT3(+2.0f, +2.0f, 0.0f) , XMFLOAT4(Colors::Yellow)\}),}
\DoxyCodeLine{00587 }
\DoxyCodeLine{00588     \};}
\DoxyCodeLine{00589 }
\DoxyCodeLine{00590 }
\DoxyCodeLine{00591     std::array<std::uint16\_t, 4> indices =}
\DoxyCodeLine{00592     \{}
\DoxyCodeLine{00593 }
\DoxyCodeLine{00594         0, 1, 2,3}
\DoxyCodeLine{00595     \};}
\DoxyCodeLine{00596 }
\DoxyCodeLine{00597 }
\DoxyCodeLine{00598 }
...
\DoxyCodeLine{00631 \}}
\DoxyCodeLine{00632 }
\DoxyCodeLine{00633 \textcolor{keywordtype}{void} ShapesApp::BuildPSOs()}
\DoxyCodeLine{00634 \{}
...
\DoxyCodeLine{00686 \}}
\DoxyCodeLine{00687 }
\DoxyCodeLine{00688 \textcolor{comment}{//build three frame resources}}
\DoxyCodeLine{00689 \textcolor{comment}{//FrameResource constructor:     FrameResource(ID3D12Device* device, UINT passCount, UINT objectCount);}}
\DoxyCodeLine{00690 }
\DoxyCodeLine{00691 \textcolor{keywordtype}{void} ShapesApp::BuildFrameResources()}
\DoxyCodeLine{00692 \{}
...
\DoxyCodeLine{00696             1, (UINT)mAllRitems.size()));}
\DoxyCodeLine{00697     \}}
\DoxyCodeLine{00698 \}}
\DoxyCodeLine{00699 }
\DoxyCodeLine{00700 \textcolor{keywordtype}{void} ShapesApp::BuildRenderItems()}
\DoxyCodeLine{00701 \{}
\DoxyCodeLine{00702     \textcolor{keyword}{auto} boxRitem = std::make\_unique<RenderItem>();}
\DoxyCodeLine{00703     XMStoreFloat4x4(\&boxRitem-\/>World, XMMatrixScaling(2.0f, 2.0f, 2.0f) * XMMatrixTranslation(0.0f, 0.5f, 0.0f));}
\DoxyCodeLine{00704     boxRitem-\/>ObjCBIndex = 0;}
\DoxyCodeLine{00705     boxRitem-\/>Geo = mGeometries[\textcolor{stringliteral}{"{}shapeGeo"{}}].get();}
\DoxyCodeLine{00706     boxRitem-\/>PrimitiveType = D3D\_PRIMITIVE\_TOPOLOGY\_4\_CONTROL\_POINT\_PATCHLIST;}
\DoxyCodeLine{00707     boxRitem-\/>IndexCount = boxRitem-\/>Geo-\/>DrawArgs[\textcolor{stringliteral}{"{}box"{}}].IndexCount;  \textcolor{comment}{//36}}
\DoxyCodeLine{00708     boxRitem-\/>StartIndexLocation = boxRitem-\/>Geo-\/>DrawArgs[\textcolor{stringliteral}{"{}box"{}}].StartIndexLocation; \textcolor{comment}{//0}}
\DoxyCodeLine{00709     boxRitem-\/>BaseVertexLocation = boxRitem-\/>Geo-\/>DrawArgs[\textcolor{stringliteral}{"{}box"{}}].BaseVertexLocation; \textcolor{comment}{//0}}
\DoxyCodeLine{00710     mAllRitems.push\_back(std::move(boxRitem));}
\DoxyCodeLine{00711 }
\DoxyCodeLine{00712 }
\DoxyCodeLine{00713     \textcolor{comment}{// All the render items are opaque.}}
\DoxyCodeLine{00714     \textcolor{comment}{//Our application will maintain lists of render items based on how they need to be}}
\DoxyCodeLine{00715     \textcolor{comment}{//drawn; that is, render items that need different PSOs will be kept in different lists.}}
\DoxyCodeLine{00716     \textcolor{keywordflow}{for} (\textcolor{keyword}{auto}\& e : mAllRitems)}
\DoxyCodeLine{00717         mOpaqueRitems.push\_back(e.get());}
\DoxyCodeLine{00718 \}}
\DoxyCodeLine{00719 }
\DoxyCodeLine{00720 \textcolor{keywordtype}{void} ShapesApp::DrawRenderItems(ID3D12GraphicsCommandList* cmdList, \textcolor{keyword}{const} std::vector<RenderItem*>\& ritems)}
\DoxyCodeLine{00721 \{}
\DoxyCodeLine{00722     UINT objCBByteSize = d3dUtil::CalcConstantBufferByteSize(\textcolor{keyword}{sizeof}(ObjectConstants));}
\DoxyCodeLine{00723 }
\DoxyCodeLine{00724     \textcolor{keyword}{auto} objectCB = mCurrFrameResource-\/>ObjectCB-\/>Resource();}
\DoxyCodeLine{00725 }
\DoxyCodeLine{00726     \textcolor{comment}{// For each render item...}}
\DoxyCodeLine{00727     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{size\_t} i = 0; i < ritems.size(); ++i)}
\DoxyCodeLine{00728     \{}
\DoxyCodeLine{00729         \textcolor{keyword}{auto} ri = ritems[i];}
\DoxyCodeLine{00730 }
\DoxyCodeLine{00731         cmdList-\/>IASetVertexBuffers(0, 1, \&ri-\/>Geo-\/>VertexBufferView());}
\DoxyCodeLine{00732         cmdList-\/>IASetIndexBuffer(\&ri-\/>Geo-\/>IndexBufferView());}
\DoxyCodeLine{00733         cmdList-\/>IASetPrimitiveTopology(ri-\/>PrimitiveType);}
\DoxyCodeLine{00734 }
\DoxyCodeLine{00735         \textcolor{comment}{// Offset to the CBV in the descriptor heap for this object and for this frame resource.}}
\DoxyCodeLine{00736         UINT cbvIndex = mCurrFrameResourceIndex * (UINT)mOpaqueRitems.size() + ri-\/>ObjCBIndex;}
\DoxyCodeLine{00737         \textcolor{keyword}{auto} cbvHandle = CD3DX12\_GPU\_DESCRIPTOR\_HANDLE(mCbvHeap-\/>GetGPUDescriptorHandleForHeapStart());}
\DoxyCodeLine{00738         cbvHandle.Offset(cbvIndex, mCbvSrvUavDescriptorSize);}
\DoxyCodeLine{00739 }
\DoxyCodeLine{00740         cmdList-\/>SetGraphicsRootDescriptorTable(0, cbvHandle);}
\DoxyCodeLine{00741 }
