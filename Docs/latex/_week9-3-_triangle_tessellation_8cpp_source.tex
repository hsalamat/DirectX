\doxysection{Week9-\/3-\/\+Triangle\+Tessellation.cpp}
...
\DoxyCodeLine{00254     \{}
\DoxyCodeLine{00255         ThrowIfFailed(mCommandList-\/>Reset(cmdListAlloc.Get(), mPSOs[\textcolor{stringliteral}{"{}wireframe"{}}].Get()));}
\DoxyCodeLine{00256     \}}
...
\DoxyCodeLine{00287 }
\DoxyCodeLine{00288     mCommandList-\/>SetPipelineState(mPSOs[\textcolor{stringliteral}{"{}wireframe"{}}].Get());}
\DoxyCodeLine{00289 }
...
\DoxyCodeLine{00306 }
\DoxyCodeLine{00307 }
\DoxyCodeLine{00308     \textcolor{comment}{//we have been calling D3DApp::FlushCommandQueue at the end of every}}
...
\DoxyCodeLine{00325 \}}
\DoxyCodeLine{00326 }
\DoxyCodeLine{00327 \textcolor{keywordtype}{void} TriangleTessellationApp::OnMouseDown(WPARAM btnState, \textcolor{keywordtype}{int} x, \textcolor{keywordtype}{int} y)}
\DoxyCodeLine{00328 \{}
...
\DoxyCodeLine{00333 \}}
\DoxyCodeLine{00334 }
\DoxyCodeLine{00335 \textcolor{keywordtype}{void} TriangleTessellationApp::OnMouseUp(WPARAM btnState, \textcolor{keywordtype}{int} x, \textcolor{keywordtype}{int} y)}
\DoxyCodeLine{00336 \{}
\DoxyCodeLine{00337     ReleaseCapture();}
\DoxyCodeLine{00338 \}}
\DoxyCodeLine{00339 }
\DoxyCodeLine{00340 \textcolor{keywordtype}{void} TriangleTessellationApp::OnMouseMove(WPARAM btnState, \textcolor{keywordtype}{int} x, \textcolor{keywordtype}{int} y)}
\DoxyCodeLine{00341 \{}
...
\DoxyCodeLine{00370 \}}
\DoxyCodeLine{00371 }
\DoxyCodeLine{00372 \textcolor{keywordtype}{void} TriangleTessellationApp::OnKeyboardInput(\textcolor{keyword}{const} GameTimer\& gt)}
\DoxyCodeLine{00373 \{}
...
\DoxyCodeLine{00384 \}}
\DoxyCodeLine{00385 }
\DoxyCodeLine{00386 \textcolor{keywordtype}{void} TriangleTessellationApp::UpdateCamera(\textcolor{keyword}{const} GameTimer\& gt)}
\DoxyCodeLine{00387 \{}
...
\DoxyCodeLine{00400 \}}
\DoxyCodeLine{00401 }
\DoxyCodeLine{00402 \textcolor{comment}{//Update resources (cbuffers) in mCurrFrameResource}}
\DoxyCodeLine{00403 \textcolor{keywordtype}{void} TriangleTessellationApp::UpdateObjectCBs(\textcolor{keyword}{const} GameTimer\& gt)}
\DoxyCodeLine{00404 \{}
...
\DoxyCodeLine{00427 \textcolor{keywordtype}{void} TriangleTessellationApp::UpdateMainPassCB(\textcolor{keyword}{const} GameTimer\& gt)}
\DoxyCodeLine{00428 \{}
...
\DoxyCodeLine{00453 \}}
\DoxyCodeLine{00454 }
\DoxyCodeLine{00455 \textcolor{keywordtype}{void} TriangleTessellationApp::BuildDescriptorHeaps()}
\DoxyCodeLine{00456 \{}
...
\DoxyCodeLine{00473 \}}
\DoxyCodeLine{00474 }
\DoxyCodeLine{00475 \textcolor{keywordtype}{void} TriangleTessellationApp::BuildConstantBufferViews()}
\DoxyCodeLine{00476 \{}
...
\DoxyCodeLine{00524 \}}
\DoxyCodeLine{00525 }
\DoxyCodeLine{00526 \textcolor{keywordtype}{void} TriangleTessellationApp::BuildRootSignature()}
\DoxyCodeLine{00527 \{}
...
\DoxyCodeLine{00567 \}}
\DoxyCodeLine{00568 }
\DoxyCodeLine{00569 \textcolor{keywordtype}{void} TriangleTessellationApp::BuildShadersAndInputLayout()}
\DoxyCodeLine{00570 \{}
...
\DoxyCodeLine{00573     mShaders[\textcolor{stringliteral}{"{}blackPS"{}}] = d3dUtil::CompileShader(L\textcolor{stringliteral}{"{}Shaders\(\backslash\)\(\backslash\)PS3.hlsl"{}}, \textcolor{keyword}{nullptr}, \textcolor{stringliteral}{"{}PS"{}}, \textcolor{stringliteral}{"{}ps\_5\_1"{}});}
\DoxyCodeLine{00574 }
\DoxyCodeLine{00575 }
\DoxyCodeLine{00576     mShaders[\textcolor{stringliteral}{"{}tessHS"{}}] = d3dUtil::CompileShader(L\textcolor{stringliteral}{"{}Shaders\(\backslash\)\(\backslash\)Tessellation.hlsl"{}}, \textcolor{keyword}{nullptr}, \textcolor{stringliteral}{"{}HS"{}}, \textcolor{stringliteral}{"{}hs\_5\_1"{}});}
\DoxyCodeLine{00577     mShaders[\textcolor{stringliteral}{"{}tessDS"{}}] = d3dUtil::CompileShader(L\textcolor{stringliteral}{"{}Shaders\(\backslash\)\(\backslash\)Tessellation.hlsl"{}}, \textcolor{keyword}{nullptr}, \textcolor{stringliteral}{"{}DS"{}}, \textcolor{stringliteral}{"{}ds\_5\_1"{}});}
\DoxyCodeLine{00578 }
...
\DoxyCodeLine{00584 \}}
\DoxyCodeLine{00585 }
\DoxyCodeLine{00586 \textcolor{keywordtype}{void} TriangleTessellationApp::BuildShapeGeometry()}
\DoxyCodeLine{00587 \{}
\DoxyCodeLine{00588     std::array<Vertex, 3> vertices =}
\DoxyCodeLine{00589     \{}
\DoxyCodeLine{00590                 Vertex(\{ XMFLOAT3(-\/1.5f, -\/1.5f, 0.0f), XMFLOAT4(Colors::Red)\}),}
\DoxyCodeLine{00591                 Vertex(\{ XMFLOAT3(+1.5f, +1.5f, 0.0f) , XMFLOAT4(Colors::Green) \}),}
\DoxyCodeLine{00592                 Vertex(\{ XMFLOAT3(+1.5f, -\/1.5f, 0.0f) , XMFLOAT4(Colors::Blue)\}),}
\DoxyCodeLine{00593 }
\DoxyCodeLine{00594     \};}
\DoxyCodeLine{00595 }
\DoxyCodeLine{00596 }
\DoxyCodeLine{00597     std::array<std::uint16\_t, 3> indices =}
\DoxyCodeLine{00598     \{}
\DoxyCodeLine{00599 }
\DoxyCodeLine{00600         0, 1, 2}
\DoxyCodeLine{00601     \};}
\DoxyCodeLine{00602 }
\DoxyCodeLine{00603 }
\DoxyCodeLine{00604 }
\DoxyCodeLine{00605     \textcolor{keyword}{const} UINT vbByteSize = (UINT)vertices.size() * \textcolor{keyword}{sizeof}(Vertex);}
\DoxyCodeLine{00606     \textcolor{keyword}{const} UINT ibByteSize = (UINT)indices.size() * \textcolor{keyword}{sizeof}(std::uint16\_t);}
\DoxyCodeLine{00607 }
\DoxyCodeLine{00608     \textcolor{keyword}{auto} mBoxGeo = std::make\_unique<MeshGeometry>();}
\DoxyCodeLine{00609     mBoxGeo-\/>Name = \textcolor{stringliteral}{"{}shapeGeo"{}};}
\DoxyCodeLine{00610 }
\DoxyCodeLine{00611     ThrowIfFailed(D3DCreateBlob(vbByteSize, \&mBoxGeo-\/>VertexBufferCPU));}
\DoxyCodeLine{00612     CopyMemory(mBoxGeo-\/>VertexBufferCPU-\/>GetBufferPointer(), vertices.data(), vbByteSize);}
\DoxyCodeLine{00613 }
\DoxyCodeLine{00614     ThrowIfFailed(D3DCreateBlob(ibByteSize, \&mBoxGeo-\/>IndexBufferCPU));}
\DoxyCodeLine{00615     CopyMemory(mBoxGeo-\/>IndexBufferCPU-\/>GetBufferPointer(), indices.data(), ibByteSize);}
\DoxyCodeLine{00616 }
\DoxyCodeLine{00617     mBoxGeo-\/>VertexBufferGPU = d3dUtil::CreateDefaultBuffer(md3dDevice.Get(),}
\DoxyCodeLine{00618         mCommandList.Get(), vertices.data(), vbByteSize, mBoxGeo-\/>VertexBufferUploader);}
\DoxyCodeLine{00619 }
\DoxyCodeLine{00620     mBoxGeo-\/>IndexBufferGPU = d3dUtil::CreateDefaultBuffer(md3dDevice.Get(),}
\DoxyCodeLine{00621         mCommandList.Get(), indices.data(), ibByteSize, mBoxGeo-\/>IndexBufferUploader);}
\DoxyCodeLine{00622 }
\DoxyCodeLine{00623     mBoxGeo-\/>VertexByteStride = \textcolor{keyword}{sizeof}(Vertex);}
\DoxyCodeLine{00624     mBoxGeo-\/>VertexBufferByteSize = vbByteSize;}
\DoxyCodeLine{00625     mBoxGeo-\/>IndexFormat = DXGI\_FORMAT\_R16\_UINT;}
\DoxyCodeLine{00626     mBoxGeo-\/>IndexBufferByteSize = ibByteSize;}
\DoxyCodeLine{00627 }
\DoxyCodeLine{00628     SubmeshGeometry submesh;}
\DoxyCodeLine{00629     submesh.IndexCount = (UINT)indices.size();}
\DoxyCodeLine{00630     submesh.StartIndexLocation = 0;}
\DoxyCodeLine{00631     submesh.BaseVertexLocation = 0;}
\DoxyCodeLine{00632 }
\DoxyCodeLine{00633     mBoxGeo-\/>DrawArgs[\textcolor{stringliteral}{"{}box"{}}] = submesh;}
\DoxyCodeLine{00634 }
\DoxyCodeLine{00635 }
\DoxyCodeLine{00636     mGeometries[mBoxGeo-\/>Name] = std::move(mBoxGeo);}
\DoxyCodeLine{00637 }
\DoxyCodeLine{00638 \}}
\DoxyCodeLine{00639 }
\DoxyCodeLine{00640 \textcolor{keywordtype}{void} TriangleTessellationApp::BuildPSOs()}
\DoxyCodeLine{00641 \{}
\DoxyCodeLine{00642     D3D12\_GRAPHICS\_PIPELINE\_STATE\_DESC opaquePsoDesc;}
\DoxyCodeLine{00643 }
\DoxyCodeLine{00644     \textcolor{comment}{//}}
\DoxyCodeLine{00645     \textcolor{comment}{// PSO for opaque objects.}}
\DoxyCodeLine{00646     \textcolor{comment}{//}}
\DoxyCodeLine{00647     ZeroMemory(\&opaquePsoDesc, \textcolor{keyword}{sizeof}(D3D12\_GRAPHICS\_PIPELINE\_STATE\_DESC));}
\DoxyCodeLine{00648     opaquePsoDesc.InputLayout = \{ mInputLayout.data(), (UINT)mInputLayout.size() \};}
\DoxyCodeLine{00649     opaquePsoDesc.pRootSignature = mRootSignature.Get();}
\DoxyCodeLine{00650     opaquePsoDesc.VS =}
\DoxyCodeLine{00651     \{}
\DoxyCodeLine{00652         \textcolor{keyword}{reinterpret\_cast<}BYTE*\textcolor{keyword}{>}(mShaders[\textcolor{stringliteral}{"{}standardVS"{}}]-\/>GetBufferPointer()),}
\DoxyCodeLine{00653         mShaders[\textcolor{stringliteral}{"{}standardVS"{}}]-\/>GetBufferSize()}
\DoxyCodeLine{00654     \};}
\DoxyCodeLine{00655     opaquePsoDesc.PS =}
\DoxyCodeLine{00656     \{}
\DoxyCodeLine{00657         \textcolor{keyword}{reinterpret\_cast<}BYTE*\textcolor{keyword}{>}(mShaders[\textcolor{stringliteral}{"{}opaquePS"{}}]-\/>GetBufferPointer()),}
\DoxyCodeLine{00658         mShaders[\textcolor{stringliteral}{"{}opaquePS"{}}]-\/>GetBufferSize()}
\DoxyCodeLine{00659     \};}
\DoxyCodeLine{00660 }
\DoxyCodeLine{00661     opaquePsoDesc.HS =}
\DoxyCodeLine{00662     \{}
\DoxyCodeLine{00663         \textcolor{keyword}{reinterpret\_cast<}BYTE*\textcolor{keyword}{>}(mShaders[\textcolor{stringliteral}{"{}tessHS"{}}]-\/>GetBufferPointer()),}
\DoxyCodeLine{00664         mShaders[\textcolor{stringliteral}{"{}tessHS"{}}]-\/>GetBufferSize()}
\DoxyCodeLine{00665     \};}
\DoxyCodeLine{00666     opaquePsoDesc.DS =}
\DoxyCodeLine{00667     \{}
\DoxyCodeLine{00668         \textcolor{keyword}{reinterpret\_cast<}BYTE*\textcolor{keyword}{>}(mShaders[\textcolor{stringliteral}{"{}tessDS"{}}]-\/>GetBufferPointer()),}
\DoxyCodeLine{00669         mShaders[\textcolor{stringliteral}{"{}tessDS"{}}]-\/>GetBufferSize()}
\DoxyCodeLine{00670     \};}
\DoxyCodeLine{00671 }
\DoxyCodeLine{00672     opaquePsoDesc.RasterizerState = CD3DX12\_RASTERIZER\_DESC(D3D12\_DEFAULT);}
\DoxyCodeLine{00673     opaquePsoDesc.RasterizerState.FillMode = D3D12\_FILL\_MODE\_SOLID;}
\DoxyCodeLine{00674     opaquePsoDesc.BlendState = CD3DX12\_BLEND\_DESC(D3D12\_DEFAULT);}
\DoxyCodeLine{00675     opaquePsoDesc.DepthStencilState = CD3DX12\_DEPTH\_STENCIL\_DESC(D3D12\_DEFAULT);}
\DoxyCodeLine{00676     opaquePsoDesc.SampleMask = UINT\_MAX;}
\DoxyCodeLine{00677     opaquePsoDesc.PrimitiveTopologyType = D3D12\_PRIMITIVE\_TOPOLOGY\_TYPE\_PATCH;}
\DoxyCodeLine{00678     opaquePsoDesc.NumRenderTargets = 1;}
\DoxyCodeLine{00679     opaquePsoDesc.RTVFormats[0] = mBackBufferFormat;}
\DoxyCodeLine{00680     opaquePsoDesc.SampleDesc.Count = m4xMsaaState ? 4 : 1;}
\DoxyCodeLine{00681     opaquePsoDesc.SampleDesc.Quality = m4xMsaaState ? (m4xMsaaQuality -\/ 1) : 0;}
\DoxyCodeLine{00682     opaquePsoDesc.DSVFormat = mDepthStencilFormat;}
\DoxyCodeLine{00683     ThrowIfFailed(md3dDevice-\/>CreateGraphicsPipelineState(\&opaquePsoDesc, IID\_PPV\_ARGS(\&mPSOs[\textcolor{stringliteral}{"{}opaque"{}}])));}
\DoxyCodeLine{00684 }
\DoxyCodeLine{00685 }
\DoxyCodeLine{00686     \textcolor{comment}{//}}
\DoxyCodeLine{00687     \textcolor{comment}{// PSO for opaque wireframe objects.}}
\DoxyCodeLine{00688     \textcolor{comment}{//}}
\DoxyCodeLine{00689 }
\DoxyCodeLine{00690     D3D12\_GRAPHICS\_PIPELINE\_STATE\_DESC opaqueWireframePsoDesc = opaquePsoDesc;}
\DoxyCodeLine{00691     opaqueWireframePsoDesc.RasterizerState.FillMode = D3D12\_FILL\_MODE\_WIREFRAME;}
\DoxyCodeLine{00692     opaqueWireframePsoDesc.DepthStencilState.DepthEnable = \textcolor{keyword}{false};}
\DoxyCodeLine{00693 }
\DoxyCodeLine{00694     opaqueWireframePsoDesc.PS =}
\DoxyCodeLine{00695     \{}
\DoxyCodeLine{00696         \textcolor{keyword}{reinterpret\_cast<}BYTE*\textcolor{keyword}{>}(mShaders[\textcolor{stringliteral}{"{}blackPS"{}}]-\/>GetBufferPointer()),}
\DoxyCodeLine{00697         mShaders[\textcolor{stringliteral}{"{}blackPS"{}}]-\/>GetBufferSize()}
\DoxyCodeLine{00698     \};}
\DoxyCodeLine{00699 }
\DoxyCodeLine{00700     ThrowIfFailed(md3dDevice-\/>CreateGraphicsPipelineState(\&opaqueWireframePsoDesc, IID\_PPV\_ARGS(\&mPSOs[\textcolor{stringliteral}{"{}wireframe"{}}])));}
\DoxyCodeLine{00701 \}}
\DoxyCodeLine{00702 }
\DoxyCodeLine{00703 }
\DoxyCodeLine{00704 \textcolor{keywordtype}{void} TriangleTessellationApp::BuildFrameResources()}
\DoxyCodeLine{00705 \{}
\DoxyCodeLine{00706     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; i < gNumFrameResources; ++i)}
\DoxyCodeLine{00707     \{}
\DoxyCodeLine{00708         mFrameResources.push\_back(std::make\_unique<FrameResource>(md3dDevice.Get(),}
\DoxyCodeLine{00709             1, (UINT)mAllRitems.size()));}
\DoxyCodeLine{00710     \}}
\DoxyCodeLine{00711 \}}
\DoxyCodeLine{00712 }
\DoxyCodeLine{00713 \textcolor{keywordtype}{void} TriangleTessellationApp::BuildRenderItems()}
\DoxyCodeLine{00714 \{}
\DoxyCodeLine{00715     \textcolor{keyword}{auto} boxRitem = std::make\_unique<RenderItem>();}
\DoxyCodeLine{00716     XMStoreFloat4x4(\&boxRitem-\/>World, XMMatrixScaling(2.0f, 2.0f, 2.0f) * XMMatrixTranslation(0.0f, 0.5f, 0.0f));}
\DoxyCodeLine{00717     boxRitem-\/>ObjCBIndex = 0;}
\DoxyCodeLine{00718     boxRitem-\/>Geo = mGeometries[\textcolor{stringliteral}{"{}shapeGeo"{}}].get();}
\DoxyCodeLine{00719     boxRitem-\/>PrimitiveType = D3D\_PRIMITIVE\_TOPOLOGY\_3\_CONTROL\_POINT\_PATCHLIST;}
\DoxyCodeLine{00720     boxRitem-\/>IndexCount = boxRitem-\/>Geo-\/>DrawArgs[\textcolor{stringliteral}{"{}box"{}}].IndexCount;  \textcolor{comment}{//36}}
\DoxyCodeLine{00721     boxRitem-\/>StartIndexLocation = boxRitem-\/>Geo-\/>DrawArgs[\textcolor{stringliteral}{"{}box"{}}].StartIndexLocation; \textcolor{comment}{//0}}
\DoxyCodeLine{00722     boxRitem-\/>BaseVertexLocation = boxRitem-\/>Geo-\/>DrawArgs[\textcolor{stringliteral}{"{}box"{}}].BaseVertexLocation; \textcolor{comment}{//0}}
\DoxyCodeLine{00723     mAllRitems.push\_back(std::move(boxRitem));}
\DoxyCodeLine{00724 }
\DoxyCodeLine{00725 }
\DoxyCodeLine{00726     \textcolor{comment}{// All the render items are opaque.}}
\DoxyCodeLine{00727     \textcolor{comment}{//Our application will maintain lists of render items based on how they need to be}}
\DoxyCodeLine{00728     \textcolor{comment}{//drawn; that is, render items that need different PSOs will be kept in different lists.}}
\DoxyCodeLine{00729     \textcolor{keywordflow}{for} (\textcolor{keyword}{auto}\& e : mAllRitems)}
\DoxyCodeLine{00730         mOpaqueRitems.push\_back(e.get());}
\DoxyCodeLine{00731 \}}
\DoxyCodeLine{00732 }
\DoxyCodeLine{00733 \textcolor{keywordtype}{void} TriangleTessellationApp::DrawRenderItems(ID3D12GraphicsCommandList* cmdList, \textcolor{keyword}{const} std::vector<RenderItem*>\& ritems)}
\DoxyCodeLine{00734 \{}
\DoxyCodeLine{00735     UINT objCBByteSize = d3dUtil::CalcConstantBufferByteSize(\textcolor{keyword}{sizeof}(ObjectConstants));}
\DoxyCodeLine{00736 }
\DoxyCodeLine{00737     \textcolor{keyword}{auto} objectCB = mCurrFrameResource-\/>ObjectCB-\/>Resource();}
\DoxyCodeLine{00738 }
\DoxyCodeLine{00739     \textcolor{comment}{// For each render item...}}
\DoxyCodeLine{00740     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{size\_t} i = 0; i < ritems.size(); ++i)}
\DoxyCodeLine{00741     \{}
\DoxyCodeLine{00742         \textcolor{keyword}{auto} ri = ritems[i];}
\DoxyCodeLine{00743 }
\DoxyCodeLine{00744         cmdList-\/>IASetVertexBuffers(0, 1, \&ri-\/>Geo-\/>VertexBufferView());}
\DoxyCodeLine{00745         cmdList-\/>IASetIndexBuffer(\&ri-\/>Geo-\/>IndexBufferView());}
\DoxyCodeLine{00746         cmdList-\/>IASetPrimitiveTopology(ri-\/>PrimitiveType);}
\DoxyCodeLine{00747 }
\DoxyCodeLine{00748         \textcolor{comment}{// Offset to the CBV in the descriptor heap for this object and for this frame resource.}}
\DoxyCodeLine{00749         UINT cbvIndex = mCurrFrameResourceIndex * (UINT)mOpaqueRitems.size() + ri-\/>ObjCBIndex;}
\DoxyCodeLine{00750         \textcolor{keyword}{auto} cbvHandle = CD3DX12\_GPU\_DESCRIPTOR\_HANDLE(mCbvHeap-\/>GetGPUDescriptorHandleForHeapStart());}
\DoxyCodeLine{00751         cbvHandle.Offset(cbvIndex, mCbvSrvUavDescriptorSize);}
\DoxyCodeLine{00752 }
\DoxyCodeLine{00753         cmdList-\/>SetGraphicsRootDescriptorTable(0, cbvHandle);}
\DoxyCodeLine{00754 }
