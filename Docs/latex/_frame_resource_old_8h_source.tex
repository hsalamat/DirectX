\doxysection{Frame\+Resource\+Old.\+h}
...
\DoxyCodeLine{00048 \textcolor{keyword}{struct }FrameResourceOld}
\DoxyCodeLine{00049 \{}
\DoxyCodeLine{00050 \textcolor{keyword}{public}:}
\DoxyCodeLine{00051     }
\DoxyCodeLine{00052     FrameResourceOld(ID3D12Device* device, UINT passCount, UINT objectCount, UINT materialCount);}
\DoxyCodeLine{00053     FrameResourceOld(\textcolor{keyword}{const} FrameResourceOld\& rhs) = \textcolor{keyword}{delete};}
\DoxyCodeLine{00054     FrameResourceOld\& operator=(\textcolor{keyword}{const} FrameResourceOld\& rhs) = \textcolor{keyword}{delete};}
\DoxyCodeLine{00055     \string~FrameResourceOld();}
\DoxyCodeLine{00056 }
