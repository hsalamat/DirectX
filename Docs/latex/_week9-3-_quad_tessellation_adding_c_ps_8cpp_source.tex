\doxysection{Week9-\/3-\/\+Quad\+Tessellation\+Adding\+CPs.cpp}
...
\DoxyCodeLine{00003 \textcolor{comment}{//Change from a quad to a Bezier bi-\/cubic.}}
\DoxyCodeLine{00004 \textcolor{comment}{//the input patch has 4 control points, but output has 16 control points and creating a bezier patch}}
...
\DoxyCodeLine{00134 }
\DoxyCodeLine{00135     \textcolor{keywordtype}{float} mTheta = 1.24f * XM\_PI;}
\DoxyCodeLine{00136     \textcolor{keywordtype}{float} mPhi = 0.42f * XM\_PI;}
\DoxyCodeLine{00137     \textcolor{keywordtype}{float} mRadius = 12.0f;}
\DoxyCodeLine{00138 }
...
\DoxyCodeLine{00151     \{}
\DoxyCodeLine{00152         ShapesApp theApp(hInstance);}
...
\DoxyCodeLine{00163 \}}
\DoxyCodeLine{00164 }
\DoxyCodeLine{00165 ShapesApp::ShapesApp(HINSTANCE hInstance)}
\DoxyCodeLine{00166     : D3DApp(hInstance)}
\DoxyCodeLine{00167 \{}
\DoxyCodeLine{00168 \}}
\DoxyCodeLine{00169 }
\DoxyCodeLine{00170 ShapesApp::\string~ShapesApp()}
\DoxyCodeLine{00171 \{}
\DoxyCodeLine{00172     \textcolor{keywordflow}{if} (md3dDevice != \textcolor{keyword}{nullptr})}
\DoxyCodeLine{00173         FlushCommandQueue();}
\DoxyCodeLine{00174 \}}
\DoxyCodeLine{00175 }
\DoxyCodeLine{00176 \textcolor{keywordtype}{bool} ShapesApp::Initialize()}
\DoxyCodeLine{00177 \{}
...
\DoxyCodeLine{00202 \}}
\DoxyCodeLine{00203 }
\DoxyCodeLine{00204 \textcolor{keywordtype}{void} ShapesApp::OnResize()}
\DoxyCodeLine{00205 \{}
...
\DoxyCodeLine{00217 }
\DoxyCodeLine{00218 \textcolor{keywordtype}{void} ShapesApp::Update(\textcolor{keyword}{const} GameTimer\& gt)}
\DoxyCodeLine{00219 \{}
...
\DoxyCodeLine{00241 \}}
\DoxyCodeLine{00242 }
\DoxyCodeLine{00243 \textcolor{keywordtype}{void} ShapesApp::Draw(\textcolor{keyword}{const} GameTimer\& gt)}
\DoxyCodeLine{00244 \{}
...
\DoxyCodeLine{00321 \}}
\DoxyCodeLine{00322 }
\DoxyCodeLine{00323 \textcolor{keywordtype}{void} ShapesApp::OnMouseDown(WPARAM btnState, \textcolor{keywordtype}{int} x, \textcolor{keywordtype}{int} y)}
\DoxyCodeLine{00324 \{}
...
\DoxyCodeLine{00329 \}}
\DoxyCodeLine{00330 }
\DoxyCodeLine{00331 \textcolor{keywordtype}{void} ShapesApp::OnMouseUp(WPARAM btnState, \textcolor{keywordtype}{int} x, \textcolor{keywordtype}{int} y)}
\DoxyCodeLine{00332 \{}
\DoxyCodeLine{00333     ReleaseCapture();}
\DoxyCodeLine{00334 \}}
\DoxyCodeLine{00335 }
\DoxyCodeLine{00336 \textcolor{keywordtype}{void} ShapesApp::OnMouseMove(WPARAM btnState, \textcolor{keywordtype}{int} x, \textcolor{keywordtype}{int} y)}
\DoxyCodeLine{00337 \{}
...
\DoxyCodeLine{00366 \}}
\DoxyCodeLine{00367 }
\DoxyCodeLine{00368 \textcolor{keywordtype}{void} ShapesApp::OnKeyboardInput(\textcolor{keyword}{const} GameTimer\& gt)}
\DoxyCodeLine{00369 \{}
...
\DoxyCodeLine{00380 \}}
\DoxyCodeLine{00381 }
\DoxyCodeLine{00382 \textcolor{keywordtype}{void} ShapesApp::UpdateCamera(\textcolor{keyword}{const} GameTimer\& gt)}
\DoxyCodeLine{00383 \{}
...
\DoxyCodeLine{00399 \textcolor{keywordtype}{void} ShapesApp::UpdateObjectCBs(\textcolor{keyword}{const} GameTimer\& gt)}
\DoxyCodeLine{00400 \{}
...
\DoxyCodeLine{00423 \textcolor{keywordtype}{void} ShapesApp::UpdateMainPassCB(\textcolor{keyword}{const} GameTimer\& gt)}
\DoxyCodeLine{00424 \{}
...
\DoxyCodeLine{00449 \}}
\DoxyCodeLine{00450 }
\DoxyCodeLine{00451 \textcolor{keywordtype}{void} ShapesApp::BuildDescriptorHeaps()}
\DoxyCodeLine{00452 \{}
...
\DoxyCodeLine{00469 \}}
\DoxyCodeLine{00470 }
\DoxyCodeLine{00471 \textcolor{keywordtype}{void} ShapesApp::BuildConstantBufferViews()}
\DoxyCodeLine{00472 \{}
...
\DoxyCodeLine{00520 \}}
\DoxyCodeLine{00521 }
\DoxyCodeLine{00522 \textcolor{keywordtype}{void} ShapesApp::BuildRootSignature()}
\DoxyCodeLine{00523 \{}
...
\DoxyCodeLine{00563 \}}
\DoxyCodeLine{00564 }
\DoxyCodeLine{00565 \textcolor{keywordtype}{void} ShapesApp::BuildShadersAndInputLayout()}
\DoxyCodeLine{00566 \{}
...
\DoxyCodeLine{00569 }
\DoxyCodeLine{00570     mShaders[\textcolor{stringliteral}{"{}tessHS"{}}] = d3dUtil::CompileShader(L\textcolor{stringliteral}{"{}Shaders\(\backslash\)\(\backslash\)Tessellation3.hlsl"{}}, \textcolor{keyword}{nullptr}, \textcolor{stringliteral}{"{}HS"{}}, \textcolor{stringliteral}{"{}hs\_5\_1"{}});}
\DoxyCodeLine{00571     mShaders[\textcolor{stringliteral}{"{}tessDS"{}}] = d3dUtil::CompileShader(L\textcolor{stringliteral}{"{}Shaders\(\backslash\)\(\backslash\)Tessellation3.hlsl"{}}, \textcolor{keyword}{nullptr}, \textcolor{stringliteral}{"{}DS"{}}, \textcolor{stringliteral}{"{}ds\_5\_1"{}});}
\DoxyCodeLine{00572 }
...
\DoxyCodeLine{00579 }
\DoxyCodeLine{00580 }
\DoxyCodeLine{00581 \textcolor{keywordtype}{void} ShapesApp::BuildShapeGeometry()}
\DoxyCodeLine{00582 \{}
\DoxyCodeLine{00583     std::array<Vertex, 4> vertices =}
\DoxyCodeLine{00584     \{}
\DoxyCodeLine{00585                 Vertex(\{ XMFLOAT3(-\/2.0f, -\/2.0f, 1.0f), XMFLOAT4(Colors::Red)\}),}
\DoxyCodeLine{00586                 Vertex(\{ XMFLOAT3(-\/2.0f, +2.0f, 1.0f) , XMFLOAT4(Colors::Green) \}),}
\DoxyCodeLine{00587                 Vertex(\{ XMFLOAT3(+2.0f, -\/2.0f, 1.0f) , XMFLOAT4(Colors::Cyan)\}),}
\DoxyCodeLine{00588                 Vertex(\{ XMFLOAT3(+2.0f, +2.0f, 1.0f) , XMFLOAT4(Colors::Yellow)\}),}
\DoxyCodeLine{00589 }
\DoxyCodeLine{00590     \};}
\DoxyCodeLine{00591 }
\DoxyCodeLine{00592 }
\DoxyCodeLine{00593     std::array<std::uint16\_t, 4> indices =}
\DoxyCodeLine{00594     \{}
\DoxyCodeLine{00595 }
...
\DoxyCodeLine{00599 }
\DoxyCodeLine{00600 }
\DoxyCodeLine{00601     \textcolor{keyword}{const} UINT vbByteSize = (UINT)vertices.size() * \textcolor{keyword}{sizeof}(Vertex);}
\DoxyCodeLine{00602     \textcolor{keyword}{const} UINT ibByteSize = (UINT)indices.size() * \textcolor{keyword}{sizeof}(std::uint16\_t);}
\DoxyCodeLine{00603 }
\DoxyCodeLine{00604     \textcolor{keyword}{auto} mBoxGeo = std::make\_unique<MeshGeometry>();}
\DoxyCodeLine{00605     mBoxGeo-\/>Name = \textcolor{stringliteral}{"{}shapeGeo"{}};}
\DoxyCodeLine{00606 }
\DoxyCodeLine{00607     ThrowIfFailed(D3DCreateBlob(vbByteSize, \&mBoxGeo-\/>VertexBufferCPU));}
\DoxyCodeLine{00608     CopyMemory(mBoxGeo-\/>VertexBufferCPU-\/>GetBufferPointer(), vertices.data(), vbByteSize);}
\DoxyCodeLine{00609 }
\DoxyCodeLine{00610     ThrowIfFailed(D3DCreateBlob(ibByteSize, \&mBoxGeo-\/>IndexBufferCPU));}
\DoxyCodeLine{00611     CopyMemory(mBoxGeo-\/>IndexBufferCPU-\/>GetBufferPointer(), indices.data(), ibByteSize);}
\DoxyCodeLine{00612 }
\DoxyCodeLine{00613     mBoxGeo-\/>VertexBufferGPU = d3dUtil::CreateDefaultBuffer(md3dDevice.Get(),}
\DoxyCodeLine{00614         mCommandList.Get(), vertices.data(), vbByteSize, mBoxGeo-\/>VertexBufferUploader);}
\DoxyCodeLine{00615 }
\DoxyCodeLine{00616     mBoxGeo-\/>IndexBufferGPU = d3dUtil::CreateDefaultBuffer(md3dDevice.Get(),}
\DoxyCodeLine{00617         mCommandList.Get(), indices.data(), ibByteSize, mBoxGeo-\/>IndexBufferUploader);}
\DoxyCodeLine{00618 }
\DoxyCodeLine{00619     mBoxGeo-\/>VertexByteStride = \textcolor{keyword}{sizeof}(Vertex);}
\DoxyCodeLine{00620     mBoxGeo-\/>VertexBufferByteSize = vbByteSize;}
\DoxyCodeLine{00621     mBoxGeo-\/>IndexFormat = DXGI\_FORMAT\_R16\_UINT;}
\DoxyCodeLine{00622     mBoxGeo-\/>IndexBufferByteSize = ibByteSize;}
\DoxyCodeLine{00623 }
\DoxyCodeLine{00624     SubmeshGeometry submesh;}
\DoxyCodeLine{00625     submesh.IndexCount = (UINT)indices.size();}
\DoxyCodeLine{00626     submesh.StartIndexLocation = 0;}
\DoxyCodeLine{00627     submesh.BaseVertexLocation = 0;}
\DoxyCodeLine{00628 }
\DoxyCodeLine{00629     mBoxGeo-\/>DrawArgs[\textcolor{stringliteral}{"{}box"{}}] = submesh;}
\DoxyCodeLine{00630 }
\DoxyCodeLine{00631 }
\DoxyCodeLine{00632     mGeometries[mBoxGeo-\/>Name] = std::move(mBoxGeo);}
\DoxyCodeLine{00633 }
\DoxyCodeLine{00634 \}}
\DoxyCodeLine{00635 }
\DoxyCodeLine{00636 \textcolor{keywordtype}{void} ShapesApp::BuildPSOs()}
\DoxyCodeLine{00637 \{}
\DoxyCodeLine{00638     D3D12\_GRAPHICS\_PIPELINE\_STATE\_DESC opaquePsoDesc;}
\DoxyCodeLine{00639 }
\DoxyCodeLine{00640     \textcolor{comment}{//}}
\DoxyCodeLine{00641     \textcolor{comment}{// PSO for opaque objects.}}
\DoxyCodeLine{00642     \textcolor{comment}{//}}
\DoxyCodeLine{00643     ZeroMemory(\&opaquePsoDesc, \textcolor{keyword}{sizeof}(D3D12\_GRAPHICS\_PIPELINE\_STATE\_DESC));}
\DoxyCodeLine{00644     opaquePsoDesc.InputLayout = \{ mInputLayout.data(), (UINT)mInputLayout.size() \};}
\DoxyCodeLine{00645     opaquePsoDesc.pRootSignature = mRootSignature.Get();}
\DoxyCodeLine{00646     opaquePsoDesc.VS =}
\DoxyCodeLine{00647     \{}
\DoxyCodeLine{00648         \textcolor{keyword}{reinterpret\_cast<}BYTE*\textcolor{keyword}{>}(mShaders[\textcolor{stringliteral}{"{}standardVS"{}}]-\/>GetBufferPointer()),}
\DoxyCodeLine{00649         mShaders[\textcolor{stringliteral}{"{}standardVS"{}}]-\/>GetBufferSize()}
\DoxyCodeLine{00650     \};}
\DoxyCodeLine{00651     opaquePsoDesc.PS =}
\DoxyCodeLine{00652     \{}
\DoxyCodeLine{00653         \textcolor{keyword}{reinterpret\_cast<}BYTE*\textcolor{keyword}{>}(mShaders[\textcolor{stringliteral}{"{}opaquePS"{}}]-\/>GetBufferPointer()),}
\DoxyCodeLine{00654         mShaders[\textcolor{stringliteral}{"{}opaquePS"{}}]-\/>GetBufferSize()}
\DoxyCodeLine{00655     \};}
\DoxyCodeLine{00656 }
\DoxyCodeLine{00657     opaquePsoDesc.HS =}
\DoxyCodeLine{00658     \{}
\DoxyCodeLine{00659         \textcolor{keyword}{reinterpret\_cast<}BYTE*\textcolor{keyword}{>}(mShaders[\textcolor{stringliteral}{"{}tessHS"{}}]-\/>GetBufferPointer()),}
\DoxyCodeLine{00660         mShaders[\textcolor{stringliteral}{"{}tessHS"{}}]-\/>GetBufferSize()}
\DoxyCodeLine{00661     \};}
\DoxyCodeLine{00662     opaquePsoDesc.DS =}
\DoxyCodeLine{00663     \{}
\DoxyCodeLine{00664         \textcolor{keyword}{reinterpret\_cast<}BYTE*\textcolor{keyword}{>}(mShaders[\textcolor{stringliteral}{"{}tessDS"{}}]-\/>GetBufferPointer()),}
\DoxyCodeLine{00665         mShaders[\textcolor{stringliteral}{"{}tessDS"{}}]-\/>GetBufferSize()}
\DoxyCodeLine{00666     \};}
\DoxyCodeLine{00667 }
\DoxyCodeLine{00668     opaquePsoDesc.RasterizerState = CD3DX12\_RASTERIZER\_DESC(D3D12\_DEFAULT);}
\DoxyCodeLine{00669     opaquePsoDesc.RasterizerState.FillMode = D3D12\_FILL\_MODE\_WIREFRAME;}
...
\DoxyCodeLine{00673     opaquePsoDesc.PrimitiveTopologyType = D3D12\_PRIMITIVE\_TOPOLOGY\_TYPE\_PATCH;}
...
\DoxyCodeLine{00679     ThrowIfFailed(md3dDevice-\/>CreateGraphicsPipelineState(\&opaquePsoDesc, IID\_PPV\_ARGS(\&mPSOs[\textcolor{stringliteral}{"{}opaque"{}}])));}
\DoxyCodeLine{00680 }
\DoxyCodeLine{00681 }
\DoxyCodeLine{00682     \textcolor{comment}{//}}
\DoxyCodeLine{00683     \textcolor{comment}{// PSO for opaque wireframe objects.}}
\DoxyCodeLine{00684     \textcolor{comment}{//}}
\DoxyCodeLine{00685 }
\DoxyCodeLine{00686     D3D12\_GRAPHICS\_PIPELINE\_STATE\_DESC opaqueWireframePsoDesc = opaquePsoDesc;}
\DoxyCodeLine{00687     opaqueWireframePsoDesc.RasterizerState.FillMode = D3D12\_FILL\_MODE\_SOLID;}
\DoxyCodeLine{00688     ThrowIfFailed(md3dDevice-\/>CreateGraphicsPipelineState(\&opaqueWireframePsoDesc, IID\_PPV\_ARGS(\&mPSOs[\textcolor{stringliteral}{"{}opaque\_wireframe"{}}])));}
\DoxyCodeLine{00689 \}}
\DoxyCodeLine{00690 }
\DoxyCodeLine{00691 \textcolor{comment}{//build three frame resources}}
\DoxyCodeLine{00692 \textcolor{comment}{//FrameResource constructor:     FrameResource(ID3D12Device* device, UINT passCount, UINT objectCount);}}
\DoxyCodeLine{00693 }
\DoxyCodeLine{00694 \textcolor{keywordtype}{void} ShapesApp::BuildFrameResources()}
\DoxyCodeLine{00695 \{}
...
\DoxyCodeLine{00699             1, (UINT)mAllRitems.size()));}
\DoxyCodeLine{00700     \}}
\DoxyCodeLine{00701 \}}
\DoxyCodeLine{00702 }
\DoxyCodeLine{00703 \textcolor{keywordtype}{void} ShapesApp::BuildRenderItems()}
\DoxyCodeLine{00704 \{}
\DoxyCodeLine{00705     \textcolor{keyword}{auto} boxRitem = std::make\_unique<RenderItem>();}
\DoxyCodeLine{00706     XMStoreFloat4x4(\&boxRitem-\/>World, XMMatrixScaling(2.0f, 2.0f, 2.0f) * XMMatrixTranslation(0.0f, 0.5f, 0.0f));}
\DoxyCodeLine{00707     boxRitem-\/>ObjCBIndex = 0;}
\DoxyCodeLine{00708     boxRitem-\/>Geo = mGeometries[\textcolor{stringliteral}{"{}shapeGeo"{}}].get();}
\DoxyCodeLine{00709     boxRitem-\/>PrimitiveType = D3D\_PRIMITIVE\_TOPOLOGY\_4\_CONTROL\_POINT\_PATCHLIST;}
\DoxyCodeLine{00710     boxRitem-\/>IndexCount = boxRitem-\/>Geo-\/>DrawArgs[\textcolor{stringliteral}{"{}box"{}}].IndexCount;  \textcolor{comment}{//36}}
\DoxyCodeLine{00711     boxRitem-\/>StartIndexLocation = boxRitem-\/>Geo-\/>DrawArgs[\textcolor{stringliteral}{"{}box"{}}].StartIndexLocation; \textcolor{comment}{//0}}
\DoxyCodeLine{00712     boxRitem-\/>BaseVertexLocation = boxRitem-\/>Geo-\/>DrawArgs[\textcolor{stringliteral}{"{}box"{}}].BaseVertexLocation; \textcolor{comment}{//0}}
\DoxyCodeLine{00713     mAllRitems.push\_back(std::move(boxRitem));}
\DoxyCodeLine{00714 }
\DoxyCodeLine{00715 }
\DoxyCodeLine{00716     \textcolor{comment}{// All the render items are opaque.}}
\DoxyCodeLine{00717     \textcolor{comment}{//Our application will maintain lists of render items based on how they need to be}}
\DoxyCodeLine{00718     \textcolor{comment}{//drawn; that is, render items that need different PSOs will be kept in different lists.}}
\DoxyCodeLine{00719     \textcolor{keywordflow}{for} (\textcolor{keyword}{auto}\& e : mAllRitems)}
\DoxyCodeLine{00720         mOpaqueRitems.push\_back(e.get());}
\DoxyCodeLine{00721 \}}
\DoxyCodeLine{00722 }
\DoxyCodeLine{00723 \textcolor{keywordtype}{void} ShapesApp::DrawRenderItems(ID3D12GraphicsCommandList* cmdList, \textcolor{keyword}{const} std::vector<RenderItem*>\& ritems)}
\DoxyCodeLine{00724 \{}
\DoxyCodeLine{00725     UINT objCBByteSize = d3dUtil::CalcConstantBufferByteSize(\textcolor{keyword}{sizeof}(ObjectConstants));}
\DoxyCodeLine{00726 }
\DoxyCodeLine{00727     \textcolor{keyword}{auto} objectCB = mCurrFrameResource-\/>ObjectCB-\/>Resource();}
\DoxyCodeLine{00728 }
...
\DoxyCodeLine{00737 }
\DoxyCodeLine{00738         \textcolor{comment}{// Offset to the CBV in the descriptor heap for this object and for this frame resource.}}
\DoxyCodeLine{00739         UINT cbvIndex = mCurrFrameResourceIndex * (UINT)mOpaqueRitems.size() + ri-\/>ObjCBIndex;}
\DoxyCodeLine{00740         \textcolor{keyword}{auto} cbvHandle = CD3DX12\_GPU\_DESCRIPTOR\_HANDLE(mCbvHeap-\/>GetGPUDescriptorHandleForHeapStart());}
\DoxyCodeLine{00741         cbvHandle.Offset(cbvIndex, mCbvSrvUavDescriptorSize);}
\DoxyCodeLine{00742 }
\DoxyCodeLine{00743         cmdList-\/>SetGraphicsRootDescriptorTable(0, cbvHandle);}
\DoxyCodeLine{00744 }
\DoxyCodeLine{00745         cmdList-\/>DrawIndexedInstanced(ri-\/>IndexCount, 1, ri-\/>StartIndexLocation, ri-\/>BaseVertexLocation, 0);}
\DoxyCodeLine{00746     \}}
\DoxyCodeLine{00747 \}}
\DoxyCodeLine{00748 }
\DoxyCodeLine{00749 }
