...
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00015}00015     \mbox{\hyperlink{class_waves_a7cf77bea4c44873f60cb1e151b8ad08a}{mNumRows}} = m;}
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00016}00016     \mbox{\hyperlink{class_waves_a522d56b02200a3cc142b1bf2969d7bc5}{mNumCols}} = n;}
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00017}00017 }
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00018}00018     \mbox{\hyperlink{class_waves_abf6b6641219ba9bd06cd0ede552dfc19}{mVertexCount}} = m*n;}
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00019}00019     \mbox{\hyperlink{class_waves_aec414c881a350e78eb2e7de2bcd8854f}{mTriangleCount}} = (m -\/ 1)*(n -\/ 1) * 2;}
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00020}00020 }
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00021}00021     \mbox{\hyperlink{class_waves_ac7fd37a783aa9868c8655d5865c09408}{mTimeStep}} = dt;}
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00022}00022     \mbox{\hyperlink{class_waves_a5d5c82991fc15e6c17a3865c448622af}{mSpatialStep}} = dx;}
...
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00026}00026     \mbox{\hyperlink{class_waves_a23a51819eda7d4e504aee2d242ef45ec}{mK1}} = (damping*dt -\/ 2.0f) / d;}
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00027}00027     \mbox{\hyperlink{class_waves_adb6810d7189db10ae11a4a7919c494d8}{mK2}} = (4.0f -\/ 8.0f*e) / d;}
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00028}00028     \mbox{\hyperlink{class_waves_a1bb7e7d104bede9e8b0dd9fc40418fa5}{mK3}} = (2.0f*e) / d;}
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00029}00029 }
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00030}00030     \mbox{\hyperlink{class_waves_a945c5ef9d997baffa12738728eb7de22}{mPrevSolution}}.resize(m*n);}
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00031}00031     \mbox{\hyperlink{class_waves_a084cb5c856035f66dfca9e13eccc967e}{mCurrSolution}}.resize(m*n);}
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00032}00032     \mbox{\hyperlink{class_waves_abf37ca1d1360f0da2c1f2396033795da}{mNormals}}.resize(m*n);}
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00033}00033     \mbox{\hyperlink{class_waves_af0c43af08c7047dcdc1bedc2ac21be03}{mTangentX}}.resize(m*n);}
...
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00046}00046             \mbox{\hyperlink{class_waves_a945c5ef9d997baffa12738728eb7de22}{mPrevSolution}}[i*n + j] = XMFLOAT3(x, 0.0f, z);}
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00047}00047             \mbox{\hyperlink{class_waves_a084cb5c856035f66dfca9e13eccc967e}{mCurrSolution}}[i*n + j] = XMFLOAT3(x, 0.0f, z);}
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00048}00048             \mbox{\hyperlink{class_waves_abf37ca1d1360f0da2c1f2396033795da}{mNormals}}[i*n + j] = XMFLOAT3(0.0f, 1.0f, 0.0f);}
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00049}00049             \mbox{\hyperlink{class_waves_af0c43af08c7047dcdc1bedc2ac21be03}{mTangentX}}[i*n + j] = XMFLOAT3(1.0f, 0.0f, 0.0f);}
...
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00060}00060     \textcolor{keywordflow}{return} \mbox{\hyperlink{class_waves_a7cf77bea4c44873f60cb1e151b8ad08a}{mNumRows}};}
...
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00065}00065     \textcolor{keywordflow}{return} \mbox{\hyperlink{class_waves_a522d56b02200a3cc142b1bf2969d7bc5}{mNumCols}};}
...
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00070}00070     \textcolor{keywordflow}{return} \mbox{\hyperlink{class_waves_abf6b6641219ba9bd06cd0ede552dfc19}{mVertexCount}};}
...
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00075}00075     \textcolor{keywordflow}{return} \mbox{\hyperlink{class_waves_aec414c881a350e78eb2e7de2bcd8854f}{mTriangleCount}};}
...
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00080}00080     \textcolor{keywordflow}{return} \mbox{\hyperlink{class_waves_a522d56b02200a3cc142b1bf2969d7bc5}{mNumCols}}*\mbox{\hyperlink{class_waves_a5d5c82991fc15e6c17a3865c448622af}{mSpatialStep}};}
...
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00085}00085     \textcolor{keywordflow}{return} \mbox{\hyperlink{class_waves_a7cf77bea4c44873f60cb1e151b8ad08a}{mNumRows}}*\mbox{\hyperlink{class_waves_a5d5c82991fc15e6c17a3865c448622af}{mSpatialStep}};}
...
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00096}00096     \textcolor{keywordflow}{if}( t >= \mbox{\hyperlink{class_waves_ac7fd37a783aa9868c8655d5865c09408}{mTimeStep}} )}
...
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00099}00099         concurrency::parallel\_for(1, \mbox{\hyperlink{class_waves_a7cf77bea4c44873f60cb1e151b8ad08a}{mNumRows}} -\/ 1, [\textcolor{keyword}{this}](\textcolor{keywordtype}{int} i)}
...
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00102}00102             \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int} j = 1; j < \mbox{\hyperlink{class_waves_a522d56b02200a3cc142b1bf2969d7bc5}{mNumCols}}-\/1; ++j)}
...
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00113}00113                 \mbox{\hyperlink{class_waves_a945c5ef9d997baffa12738728eb7de22}{mPrevSolution}}[i*\mbox{\hyperlink{class_waves_a522d56b02200a3cc142b1bf2969d7bc5}{mNumCols}}+j].y = }
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00114}00114                     \mbox{\hyperlink{class_waves_a23a51819eda7d4e504aee2d242ef45ec}{mK1}}*\mbox{\hyperlink{class_waves_a945c5ef9d997baffa12738728eb7de22}{mPrevSolution}}[i*\mbox{\hyperlink{class_waves_a522d56b02200a3cc142b1bf2969d7bc5}{mNumCols}}+j].y +}
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00115}00115                     \mbox{\hyperlink{class_waves_adb6810d7189db10ae11a4a7919c494d8}{mK2}}*\mbox{\hyperlink{class_waves_a084cb5c856035f66dfca9e13eccc967e}{mCurrSolution}}[i*\mbox{\hyperlink{class_waves_a522d56b02200a3cc142b1bf2969d7bc5}{mNumCols}}+j].y +}
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00116}00116                     \mbox{\hyperlink{class_waves_a1bb7e7d104bede9e8b0dd9fc40418fa5}{mK3}}*(\mbox{\hyperlink{class_waves_a084cb5c856035f66dfca9e13eccc967e}{mCurrSolution}}[(i+1)*\mbox{\hyperlink{class_waves_a522d56b02200a3cc142b1bf2969d7bc5}{mNumCols}}+j].y + }
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00117}00117                          \mbox{\hyperlink{class_waves_a084cb5c856035f66dfca9e13eccc967e}{mCurrSolution}}[(i-\/1)*\mbox{\hyperlink{class_waves_a522d56b02200a3cc142b1bf2969d7bc5}{mNumCols}}+j].y + }
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00118}00118                          \mbox{\hyperlink{class_waves_a084cb5c856035f66dfca9e13eccc967e}{mCurrSolution}}[i*\mbox{\hyperlink{class_waves_a522d56b02200a3cc142b1bf2969d7bc5}{mNumCols}}+j+1].y + }
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00119}00119                          \mbox{\hyperlink{class_waves_a084cb5c856035f66dfca9e13eccc967e}{mCurrSolution}}[i*\mbox{\hyperlink{class_waves_a522d56b02200a3cc142b1bf2969d7bc5}{mNumCols}}+j-\/1].y);}
...
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00126}00126         std::swap(\mbox{\hyperlink{class_waves_a945c5ef9d997baffa12738728eb7de22}{mPrevSolution}}, \mbox{\hyperlink{class_waves_a084cb5c856035f66dfca9e13eccc967e}{mCurrSolution}});}
...
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00133}00133         concurrency::parallel\_for(1, \mbox{\hyperlink{class_waves_a7cf77bea4c44873f60cb1e151b8ad08a}{mNumRows}} -\/ 1, [\textcolor{keyword}{this}](\textcolor{keywordtype}{int} i)}
...
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00136}00136             \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int} j = 1; j < \mbox{\hyperlink{class_waves_a522d56b02200a3cc142b1bf2969d7bc5}{mNumCols}}-\/1; ++j)}
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00137}00137             \{}
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00138}00138                 \textcolor{keywordtype}{float} l = \mbox{\hyperlink{class_waves_a084cb5c856035f66dfca9e13eccc967e}{mCurrSolution}}[i*\mbox{\hyperlink{class_waves_a522d56b02200a3cc142b1bf2969d7bc5}{mNumCols}}+j-\/1].y;}
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00139}00139                 \textcolor{keywordtype}{float} r = \mbox{\hyperlink{class_waves_a084cb5c856035f66dfca9e13eccc967e}{mCurrSolution}}[i*\mbox{\hyperlink{class_waves_a522d56b02200a3cc142b1bf2969d7bc5}{mNumCols}}+j+1].y;}
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00140}00140                 \textcolor{keywordtype}{float} t = \mbox{\hyperlink{class_waves_a084cb5c856035f66dfca9e13eccc967e}{mCurrSolution}}[(i-\/1)*\mbox{\hyperlink{class_waves_a522d56b02200a3cc142b1bf2969d7bc5}{mNumCols}}+j].y;}
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00141}00141                 \textcolor{keywordtype}{float} b = \mbox{\hyperlink{class_waves_a084cb5c856035f66dfca9e13eccc967e}{mCurrSolution}}[(i+1)*\mbox{\hyperlink{class_waves_a522d56b02200a3cc142b1bf2969d7bc5}{mNumCols}}+j].y;}
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00142}00142                 \mbox{\hyperlink{class_waves_abf37ca1d1360f0da2c1f2396033795da}{mNormals}}[i*\mbox{\hyperlink{class_waves_a522d56b02200a3cc142b1bf2969d7bc5}{mNumCols}}+j].x = -\/r+l;}
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00143}00143                 \mbox{\hyperlink{class_waves_abf37ca1d1360f0da2c1f2396033795da}{mNormals}}[i*\mbox{\hyperlink{class_waves_a522d56b02200a3cc142b1bf2969d7bc5}{mNumCols}}+j].y = 2.0f*\mbox{\hyperlink{class_waves_a5d5c82991fc15e6c17a3865c448622af}{mSpatialStep}};}
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00144}00144                 \mbox{\hyperlink{class_waves_abf37ca1d1360f0da2c1f2396033795da}{mNormals}}[i*\mbox{\hyperlink{class_waves_a522d56b02200a3cc142b1bf2969d7bc5}{mNumCols}}+j].z = b-\/t;}
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00145}00145 }
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00146}00146                 XMVECTOR n = XMVector3Normalize(XMLoadFloat3(\&\mbox{\hyperlink{class_waves_abf37ca1d1360f0da2c1f2396033795da}{mNormals}}[i*\mbox{\hyperlink{class_waves_a522d56b02200a3cc142b1bf2969d7bc5}{mNumCols}}+j]));}
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00147}00147                 XMStoreFloat3(\&\mbox{\hyperlink{class_waves_abf37ca1d1360f0da2c1f2396033795da}{mNormals}}[i*\mbox{\hyperlink{class_waves_a522d56b02200a3cc142b1bf2969d7bc5}{mNumCols}}+j], n);}
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00148}00148 }
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00149}00149                 \mbox{\hyperlink{class_waves_af0c43af08c7047dcdc1bedc2ac21be03}{mTangentX}}[i*\mbox{\hyperlink{class_waves_a522d56b02200a3cc142b1bf2969d7bc5}{mNumCols}}+j] = XMFLOAT3(2.0f*\mbox{\hyperlink{class_waves_a5d5c82991fc15e6c17a3865c448622af}{mSpatialStep}}, r-\/l, 0.0f);}
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00150}00150                 XMVECTOR T = XMVector3Normalize(XMLoadFloat3(\&\mbox{\hyperlink{class_waves_af0c43af08c7047dcdc1bedc2ac21be03}{mTangentX}}[i*\mbox{\hyperlink{class_waves_a522d56b02200a3cc142b1bf2969d7bc5}{mNumCols}}+j]));}
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00151}00151                 XMStoreFloat3(\&\mbox{\hyperlink{class_waves_af0c43af08c7047dcdc1bedc2ac21be03}{mTangentX}}[i*\mbox{\hyperlink{class_waves_a522d56b02200a3cc142b1bf2969d7bc5}{mNumCols}}+j], T);}
...
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00160}00160     assert(i > 1 \&\& i < \mbox{\hyperlink{class_waves_a7cf77bea4c44873f60cb1e151b8ad08a}{mNumRows}}-\/2);}
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00161}00161     assert(j > 1 \&\& j < \mbox{\hyperlink{class_waves_a522d56b02200a3cc142b1bf2969d7bc5}{mNumCols}}-\/2);}
...
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00166}00166     \mbox{\hyperlink{class_waves_a084cb5c856035f66dfca9e13eccc967e}{mCurrSolution}}[i*\mbox{\hyperlink{class_waves_a522d56b02200a3cc142b1bf2969d7bc5}{mNumCols}}+j].y     += magnitude;}
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00167}00167     \mbox{\hyperlink{class_waves_a084cb5c856035f66dfca9e13eccc967e}{mCurrSolution}}[i*\mbox{\hyperlink{class_waves_a522d56b02200a3cc142b1bf2969d7bc5}{mNumCols}}+j+1].y   += halfMag;}
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00168}00168     \mbox{\hyperlink{class_waves_a084cb5c856035f66dfca9e13eccc967e}{mCurrSolution}}[i*\mbox{\hyperlink{class_waves_a522d56b02200a3cc142b1bf2969d7bc5}{mNumCols}}+j-\/1].y   += halfMag;}
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00169}00169     \mbox{\hyperlink{class_waves_a084cb5c856035f66dfca9e13eccc967e}{mCurrSolution}}[(i+1)*\mbox{\hyperlink{class_waves_a522d56b02200a3cc142b1bf2969d7bc5}{mNumCols}}+j].y += halfMag;}
\DoxyCodeLine{\Hypertarget{_week8_2_blur_2_waves_8cpp_source_l00170}00170     \mbox{\hyperlink{class_waves_a084cb5c856035f66dfca9e13eccc967e}{mCurrSolution}}[(i-\/1)*\mbox{\hyperlink{class_waves_a522d56b02200a3cc142b1bf2969d7bc5}{mNumCols}}+j].y += halfMag;}
