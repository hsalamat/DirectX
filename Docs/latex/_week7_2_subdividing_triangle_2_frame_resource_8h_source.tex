...
\DoxyCodeLine{00031 }
\DoxyCodeLine{00032     \textcolor{comment}{//DirectX::XMFLOAT4 FogColor = \{ 0.7f, 0.7f, 0.7f, 1.0f \};}}
\DoxyCodeLine{00033     \textcolor{comment}{//float gFogStart = 5.0f;}}
\DoxyCodeLine{00034     \textcolor{comment}{//float gFogRange = 150.0f;}}
\DoxyCodeLine{00035     \textcolor{comment}{//DirectX::XMFLOAT2 cbPerObjectPad2;}}
\DoxyCodeLine{00036 }
...
\DoxyCodeLine{00058     FrameResource(ID3D12Device* device, UINT passCount, UINT objectCount, UINT materialCount);}
