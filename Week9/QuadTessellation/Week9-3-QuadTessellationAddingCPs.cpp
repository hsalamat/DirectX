...
void ShapesApp::BuildShadersAndInputLayout()
{
	...
	mShaders["tessHS"] = d3dUtil::CompileShader(L"Shaders\\Tessellation3.hlsl", nullptr, "HS", "hs_5_1");
	mShaders["tessDS"] = d3dUtil::CompileShader(L"Shaders\\Tessellation3.hlsl", nullptr, "DS", "ds_5_1");
...
void ShapesApp::BuildShapeGeometry()
{
	std::array<Vertex, 4> vertices =
	{
				...
				Vertex({ XMFLOAT3(-2.0f, +2.0f, 1.0f) , XMFLOAT4(Colors::Green) }),
				Vertex({ XMFLOAT3(+2.0f, -2.0f, 1.0f) , XMFLOAT4(Colors::Cyan)}),
				Vertex({ XMFLOAT3(+2.0f, +2.0f, 1.0f) , XMFLOAT4(Colors::Yellow)}),
