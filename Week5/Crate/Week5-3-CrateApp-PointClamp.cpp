/** @file Week5-3-CrateApp-PointClamp.cpp
 *  @brief Texture Demo using Point Filtering and Clamp Address Mode !
...
{
	mShaders["standardVS"] = d3dUtil::CompileShader(L"Shaders\\Default_PointClamp.hlsl", nullptr, "VS", "vs_5_0");
	mShaders["opaquePS"] = d3dUtil::CompileShader(L"Shaders\\Default_PointClamp.hlsl", nullptr, "PS", "ps_5_0");
