...
{
	//step4
	mShaders["standardVS"] = d3dUtil::CompileShader(L"Shaders\\VS_DirectLight.hlsl", nullptr, "VS", "vs_5_1");
	mShaders["opaquePS"] = d3dUtil::CompileShader(L"Shaders\\PS_DirectLight.hlsl", nullptr, "PS", "ps_5_1");
